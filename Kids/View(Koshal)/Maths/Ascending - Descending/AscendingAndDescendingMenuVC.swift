//
//  AscendingAndDescendingMenuVC.swift
//  KSchool
//
...
class AscendingAndDescendingMenuVC: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        if isAscendingMode {
            titelLbl.text = "Ascending Order Level".localiz()
        } else {
            titelLbl.text = "Descending Order Level".localiz()
        }
    }
    ...
    func updateLevelUI(level: Int, imageView: UIImageView, label: UILabel) {
        ...
        let mode = isAscendingMode ? "ascending" : "descending"
    ...
    @IBAction func level1TapBtn(_ sender: UIButton) {
        ...
        vc.isAscending = isAscendingMode   // ✅ FIX
        vc.numberRange = 1...100
        vc.levelNumber = 1
    ...
    @IBAction func level2TapBtn(_ sender: UIButton) {
        ...
        vc.isAscending = isAscendingMode
        vc.numberRange = 100...200
        vc.levelNumber = 2
        navigationController?.pushViewController(vc, animated: true)
    }
