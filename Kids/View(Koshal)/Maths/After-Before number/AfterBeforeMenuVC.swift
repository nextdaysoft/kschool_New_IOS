...
class AfterBeforeMenuVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        if screenTitleText == "After Number" {
            
            UserDefaults.standard.set(true, forKey: "mathsLevel5Completed")
            UserDefaults.standard.set(percentage, forKey: "mathsLevel5Percentage")
            
        } else {
            
            UserDefaults.standard.set(true, forKey: "mathsLevel6Completed")
            UserDefaults.standard.set(percentage, forKey: "mathsLevel6Percentage")
        }
        ...
        if let mathsVC = navigationController?.viewControllers.first(
            ...
            if screenTitleText == "After Number" {
                mathsVC.updateLevel(level: 5, percentage: percentage)
            } else {
                mathsVC.updateLevel(level: 6, percentage: percentage)
            }
