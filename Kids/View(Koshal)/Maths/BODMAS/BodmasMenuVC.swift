...
class BodmasMenuVC: BaseViewController {
    ...
    func updateResetVisibility() {
        ...
        let isAnyCompleted =
            UserDefaults.standard.bool(forKey: "bodmasLevel1Completed") ||
            UserDefaults.standard.bool(forKey: "bodmasLevel2Completed") ||
            UserDefaults.standard.bool(forKey: "bodmasLevel3Completed") ||
            UserDefaults.standard.bool(forKey: "bodmasLevel4Completed") ||
            UserDefaults.standard.bool(forKey: "bodmasLevel5Completed") ||
            UserDefaults.standard.bool(forKey: "bodmasLevel6Completed") ||
            UserDefaults.standard.bool(forKey: "bodmasLevel7Completed") ||
            UserDefaults.standard.bool(forKey: "bodmasLevel8Completed") ||
            UserDefaults.standard.bool(forKey: "bodmasLevel9Completed") ||
            UserDefaults.standard.bool(forKey: "bodmasLevel10Completed")
    ...
    func updateLevelUI(level: Int, imageView: UIImageView, label: UILabel) {
        ...
        let completedKey = "bodmasLevel\(level)Completed"

        if UserDefaults.standard.bool(forKey: completedKey) {

            // ✅ Image
            let imageName = UserDefaults.standard.string(forKey: "bodmasLevel\(level)Image") ?? "done"
            imageView.image = UIImage(named: imageName)

            // ✅ Percentage
            let levelData = UserDefaults.standard.dictionary(forKey: "bodmasLevelData") as? [String: Int]
            let percentage = levelData?["\(level)"] ?? 0
    ...
    @IBAction func level1TapBtn(_ sender: UIButton) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "BodmasShowVC") as! BodmasShowVC
        vc.levelNumber = 1
    ...
    @IBAction func restTapBtn(_ sender: UIButton) {
        ...
        for i in 1...10 {
            defaults.removeObject(forKey: "bodmasLevel\(i)Completed")
        }
