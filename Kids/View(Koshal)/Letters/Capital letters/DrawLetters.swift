...
class DrawLetters: BaseViewController {
    // MARK: Outlet
    ...
    @IBOutlet weak var draw: LetterDrawCapitalView!
    @IBOutlet weak var trace: LetterTraceCapitalView!
    ...
    @IBOutlet weak var titelLbl: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        view.bringSubviewToFront(trace)
   ...
   // MARK: Function
    ...
    func speakLetter(_ letter: String) {
        speechSynthesizer.stopSpeaking(at: .immediate) // 🔥 important
    ...
    private func loadLetter(at index: Int) {
        ...
        let data = AlphabetPathProvider.strokeData(
            for: letters[index],
            style: letterStyle
        )
    ...
    func goToResultScreen() {
        ...
        if let vc = storyboard.instantiateViewController(
            ...
            if letterStyle == .cursive {

                vc.levelKey = "letterLevel4Completed"
                vc.titleText = "Capital Cursive Letter"

            } else {

                vc.levelKey = "letterLevel1Completed"
    ...
    @IBAction func speakBtn(_ sender: UIButton) {
        speakLetter(String(letters[letterIndex]).lowercased())
    }
  ...
  //  MARK: Action
    ...
    @IBAction func repeatTapped(_ sender: UIButton) {
        trace.resetTrace()   // ✅ sirf tracing reset
    ...
    func goToSubScreenWithDone() {
        onCompleted?()   // 🔥 DATA PASS BACK
