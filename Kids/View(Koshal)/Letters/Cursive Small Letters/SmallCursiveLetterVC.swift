...
class SmallCursiveLetterVC: BaseViewController {
    ...
    @IBOutlet weak var draw: LetterDrawSmallCursiveVC!
    @IBOutlet weak var trace: LetterTraceSmallCursiveVC!
    ...
    private func loadLetter(at index: Int) {
        ...
        let data = SmallCursiveAlphabetPath.strokeData(
            for: letters[index]
        )
    ...
    func goToResultScreen() {
        ...
        if let vc = storyboard.instantiateViewController(
            ...
            vc.levelKey = "letterLevel5Completed"
            vc.titleText = "Small Cursive Letter"
