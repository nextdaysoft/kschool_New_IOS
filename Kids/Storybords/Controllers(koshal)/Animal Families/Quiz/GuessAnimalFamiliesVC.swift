...
class GuessAnimalFamiliesVC: BaseViewController, AVSpeechSynthesizerDelegate {
   ...
   // @IBOutlet weak var LevelLabel: UILabel!
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessAnimalFamiliesResultVC"
        ) as? GuessAnimalFamiliesResultVC {
