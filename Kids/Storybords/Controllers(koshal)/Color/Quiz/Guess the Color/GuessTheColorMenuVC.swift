...
class GuessTheColorMenuVC: BaseViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        for i in 1...6 {
            print("Level \(i) Completed:",
                  UserDefaults.standard.bool(forKey: "guessTheColorLevel\(i)Completed"))
        }
    ...
    func updateResetVisibility() {
        ...
        let levelData = UserDefaults.standard.dictionary(forKey: "guessTheColorLevelData") as? [String: Int]
    ...
    @IBAction func level1TapBtn(_ sender: UIButton) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "GuessTheColorShowVC") as! GuessTheColorShowVC
        vc.colors = colors1
        vc.levelNumber = 1
    ...
    @IBAction func level3TapBtn(_ sender: UIButton) {
        ...
        let vc = storyboard?.instantiateViewController(
            withIdentifier: "GuessTheColorShowVC"
        ) as! GuessTheColorShowVC
