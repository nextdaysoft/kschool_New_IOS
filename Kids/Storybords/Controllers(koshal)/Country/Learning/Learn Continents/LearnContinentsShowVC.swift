...
class LearnContinentsShowVC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        .init(text: "Antarctica", imageName: "continent_antarctica"),
        .init(text: "South America", imageName: "continent_south_america"),
        .init(text: "Africa", imageName: "continent_africa"),
        .init(text: "Europe", imageName: "continent_europe"),
        .init(text: "Asia", imageName: "continent_asia"),
        .init(text: "North America", imageName: "continent_north_america"),
        .init(text: "Australia (also called Oceania)", imageName: "continent_australia"),
    ]
    ...
    func showSwipeUpHint() {
        ...
        let label = UILabel()
        label.text = "Swipe up to change continents"
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        let viewedItems = Array(
            planets.prefix(currentIndex + 1)
        )

        // ✅ Sirf aage wale items reshuffle
        var remainingItems = Array(
            planets.dropFirst(currentIndex + 1)
        )

        remainingItems.shuffle()

        planets = viewedItems + remainingItems
    ...
    func createFruitsPDF() -> URL? {
        ...
        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("Continents.pdf")
