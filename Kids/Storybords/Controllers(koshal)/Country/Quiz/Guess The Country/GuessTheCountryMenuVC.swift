...
class GuessTheCountryMenuVC: BaseViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        for i in 1...20 {
            print("Level \(i) Completed:",
                  UserDefaults.standard.bool(forKey: "guessTheCountryLevel\(i)Completed"))
        }
    ...
    @IBAction func level1TapBtn(_ sender: UIButton) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "GuessTheCountryShowVC") as! GuessTheCountryShowVC
        vc.planets = planets1
        vc.levelNumber = 1
