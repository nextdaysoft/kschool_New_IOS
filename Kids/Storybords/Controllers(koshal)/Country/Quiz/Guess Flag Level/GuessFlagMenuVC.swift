...
class GuessFlagMenuVC: BaseViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        for i in 1...20 {
            print("Level \(i) Completed:",
                  UserDefaults.standard.bool(forKey: "guessFlagLevel\(i)Completed"))
        }
    ...
    func updateResetVisibility() {
        ...
        let levelData = UserDefaults.standard.dictionary(forKey: "guessFlagLevelData") as? [String: Int]
    ...
    func setupSubscriptionLock() {
        ...
        let levels: [(Int, UIImageView?, UIView?, UILabel?)] = [
            ...
            (6,image6,viewBG6,label6),
            (7,image7,viewBG7,label7),
            (8,image8,viewBG8,label8),
            (9,image9,viewBG9,label9),
            (10,image10,viewBG10,label10),
            (11,image11,viewBG11,label11),
            (12,image12,viewBG12,label12),
            (13,image13,viewBG13,label13),
            (14,image14,viewBG14,label14),
            (15,image15,viewBG15,label15),
            (16,image16,viewBG16,label16),
            (17,image17,viewBG17,label17),
            (18,image18,viewBG18,label18),
            (19,image19,viewBG19,label19),
            (20,image20,viewBG20,label20)
        ]
    ...
    @IBAction func level1TapBtn(_ sender: UIButton) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "GuessFlagShowVC") as! GuessFlagShowVC
        vc.planets = planets1
        vc.levelNumber = 1
