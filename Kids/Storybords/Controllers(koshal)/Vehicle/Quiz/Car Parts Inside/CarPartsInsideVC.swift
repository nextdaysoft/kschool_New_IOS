...
class CarPartsInsideVC: BaseViewController {

    @IBOutlet weak var aCVentView: UIView!
    @IBOutlet weak var rearViewMirrorView: UIView!
    @IBOutlet weak var breakView: UIView!
    @IBOutlet weak var steeringView: UIView!
    @IBOutlet weak var seatBeltView: UIView!
    @IBOutlet weak var gearStickView: UIView!
    @IBOutlet weak var clutchView: UIView!
    @IBOutlet weak var acceleratorView: UIView!
    
    @IBOutlet weak var rearViewMirrorLineView: UIView!
    ...
    override func viewDidLoad() {
        ...
        rearViewMirrorLineView.transform = CGAffineTransform(rotationAngle: -0.35)
        ...
        setupView(aCVentView)
        setupView(rearViewMirrorView)
        setupView(breakView)
        setupView(steeringView)
        setupView(seatBeltView)
        setupView(gearStickView)
        setupView(clutchView)
        setupView(acceleratorView)
        ...
        correctMapping = [
            aCVentView: "AC Vent",
            rearViewMirrorView: "Rear-view Mirror",
            breakView: "Break",
            steeringView: "Steering",
            seatBeltView: "Seat Belt",
            gearStickView: "Gear Stick",
            clutchView: "Clutch",
            acceleratorView: "Accelerator"
        ]
    ...
    func checkDrop(_ draggedView: UIView) {
        ...
        let targets: [UIView: UIView] = [
            view1: aCVentView,
            view2: rearViewMirrorView,
            view3: breakView,
            view4: steeringView,
            view5: seatBeltView,
            view6: gearStickView,
            view7: clutchView,
            view8: acceleratorView
        ]
    ...
    @IBAction func nextAndUndoTapBtn(_ sender: UIButton) {
        ...
        if let menuVC = navigationController?.viewControllers.first(
            ...
            UserDefaults.standard.set(true, forKey: "vehicleLevel4Completed")
            UserDefaults.standard.set(percentage, forKey: "vehicleLevel4Percentage")
