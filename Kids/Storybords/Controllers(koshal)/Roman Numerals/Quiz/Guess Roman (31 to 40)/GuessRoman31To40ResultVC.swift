//
//  GuessRoman31To40ResultVC.swift
//  KSchool
//
...
class GuessRoman31To40ResultVC: BaseViewController {
    ...
    func goToMenu(markCompleted: Bool = true) {
        ...
        if markCompleted {
            UserDefaults.standard.set(true, forKey: "romanNumeralsLevel5Completed")
            UserDefaults.standard.set(percentage, forKey: "romanNumeralsLevel5Percentage")
        }
