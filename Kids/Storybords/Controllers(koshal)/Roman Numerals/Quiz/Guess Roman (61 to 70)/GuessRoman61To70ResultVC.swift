//
//  GuessRoman61To70ResultVC.swift
//  KSchool
//
...
class GuessRoman61To70ResultVC: BaseViewController {
    ...
    func goToMenu(markCompleted: Bool = true) {
        ...
        if markCompleted {
            UserDefaults.standard.set(true, forKey: "romanNumeralsLevel8Completed")
            UserDefaults.standard.set(percentage, forKey: "romanNumeralsLevel8Percentage")
        }
