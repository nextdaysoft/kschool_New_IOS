...
class GuessRoman61To70ShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    var capacityUnitQuestions: [WeightUnitQuestion] = [
        ...
        WeightUnitQuestion(
            question: "61",
            options: ["LXI", "LX", "LIX", "LXII"],
            correctAnswer: "LXI"
        ),

        WeightUnitQuestion(
            question: "62",
            options: ["LXII", "LXI", "LXIII", "LX"],
            correctAnswer: "LXII"
        ),

        WeightUnitQuestion(
            question: "63",
            options: ["LXIII", "LXII", "LXIV", "LXI"],
            correctAnswer: "LXIII"
        ),

        WeightUnitQuestion(
            question: "64",
            options: ["LXIV", "LXV", "LXIII", "LXII"],
            correctAnswer: "LXIV"
        ),

        WeightUnitQuestion(
            question: "65",
            options: ["LXV", "LXIV", "LXVI", "LXIII"],
            correctAnswer: "LXV"
        ),

        WeightUnitQuestion(
            question: "66",
            options: ["LXVI", "LXV", "LXVII", "LXIV"],
            correctAnswer: "LXVI"
        ),

        WeightUnitQuestion(
            question: "67",
            options: ["LXVII", "LXVI", "LXVIII", "LXV"],
            correctAnswer: "LXVII"
        ),

        WeightUnitQuestion(
            question: "68",
            options: ["LXVIII", "LXVII", "LXIX", "LXVI"],
            correctAnswer: "LXVIII"
        ),

        WeightUnitQuestion(
            question: "69",
            options: ["LXIX", "LXX", "LXVIII", "LXVII"],
            correctAnswer: "LXIX"
        ),

        WeightUnitQuestion(
            question: "70",
            options: ["LXX", "LXIX", "LXVIII", "LXV"],
            correctAnswer: "LXX"
        )
    ]
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessRoman61To70ResultVC"
        ) as? GuessRoman61To70ResultVC {
