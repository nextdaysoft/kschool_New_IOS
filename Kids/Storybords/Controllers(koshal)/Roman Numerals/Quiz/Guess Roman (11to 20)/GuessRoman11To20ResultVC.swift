//
//  GuessRoman11To20ResultVC.swift
//  KSchool
//
...
class GuessRoman11To20ResultVC: BaseViewController {
    ...
    func goToMenu(markCompleted: Bool = true) {
        ...
        if markCompleted {
            UserDefaults.standard.set(true, forKey: "romanNumeralsLevel3Completed")
            UserDefaults.standard.set(percentage, forKey: "romanNumeralsLevel3Percentage")
        }
