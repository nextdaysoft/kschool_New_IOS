//
//  GuessRoman51To60ResultVC.swift
//  KSchool
//
...
class GuessRoman51To60ResultVC: BaseViewController {
    ...
    func goToMenu(markCompleted: Bool = true) {
        ...
        if markCompleted {
            UserDefaults.standard.set(true, forKey: "romanNumeralsLevel7Completed")
            UserDefaults.standard.set(percentage, forKey: "romanNumeralsLevel7Percentage")
        }
