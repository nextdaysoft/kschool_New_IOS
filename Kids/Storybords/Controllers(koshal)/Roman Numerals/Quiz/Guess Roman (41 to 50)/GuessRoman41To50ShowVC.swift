...
class GuessRoman41To50ShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    var capacityUnitQuestions: [WeightUnitQuestion] = [
        ...
        WeightUnitQuestion(
            question: "41",
            options: ["XLI", "XL", "XXXIX", "XLII"],
            correctAnswer: "XLI"
        ),

        WeightUnitQuestion(
            question: "42",
            options: ["XLII", "XLI", "XLIII", "XL"],
            correctAnswer: "XLII"
        ),

        WeightUnitQuestion(
            question: "43",
            options: ["XLIII", "XLII", "XLIV", "XLI"],
            correctAnswer: "XLIII"
        ),

        WeightUnitQuestion(
            question: "44",
            options: ["XLIV", "XLV", "XLIII", "XLII"],
            correctAnswer: "XLIV"
        ),

        WeightUnitQuestion(
            question: "45",
            options: ["XLV", "XLIV", "XLVI", "XLIII"],
            correctAnswer: "XLV"
        ),

        WeightUnitQuestion(
            question: "46",
            options: ["XLVI", "XLV", "XLVII", "XLIV"],
            correctAnswer: "XLVI"
        ),

        WeightUnitQuestion(
            question: "47",
            options: ["XLVII", "XLVI", "XLVIII", "XLV"],
            correctAnswer: "XLVII"
        ),

        WeightUnitQuestion(
            question: "48",
            options: ["XLVIII", "XLVII", "XLIX", "XLVI"],
            correctAnswer: "XLVIII"
        ),

        WeightUnitQuestion(
            question: "49",
            options: ["XLIX", "L", "XLVIII", "XLVII"],
            correctAnswer: "XLIX"
        ),

        WeightUnitQuestion(
            question: "50",
            options: ["L", "XLIX", "XLVIII", "XLV"],
            correctAnswer: "L"
        )
    ]
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessRoman41To50ResultVC"
        ) as? GuessRoman41To50ResultVC {
