//
//  GuessRoman1To100ResultVC.swift
//  KSchool
//
...
class GuessRoman1To100ResultVC: BaseViewController {
    ...
    func goToMenu(markCompleted: Bool = true) {
        ...
        if markCompleted {
            UserDefaults.standard.set(true, forKey: "romanNumeralsLevel12Completed")
            UserDefaults.standard.set(percentage, forKey: "romanNumeralsLevel12Percentage")
        }
