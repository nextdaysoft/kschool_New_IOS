//
//  GuessRoman81To90ResultVC.swift
//  KSchool
//
...
class GuessRoman81To90ResultVC: BaseViewController {
    ...
    func goToMenu(markCompleted: Bool = true) {
        ...
        if markCompleted {
            UserDefaults.standard.set(true, forKey: "romanNumeralsLevel10Completed")
            UserDefaults.standard.set(percentage, forKey: "romanNumeralsLevel10Percentage")
        }
