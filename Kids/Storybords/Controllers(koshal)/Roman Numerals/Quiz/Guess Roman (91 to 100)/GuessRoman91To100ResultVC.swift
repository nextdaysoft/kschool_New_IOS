//
//  GuessRoman91To100ResultVC.swift
//  KSchool
//
...
class GuessRoman91To100ResultVC: BaseViewController {
    ...
    func goToMenu(markCompleted: Bool = true) {
        ...
        if markCompleted {
            UserDefaults.standard.set(true, forKey: "romanNumeralsLevel11Completed")
            UserDefaults.standard.set(percentage, forKey: "romanNumeralsLevel11Percentage")
        }
