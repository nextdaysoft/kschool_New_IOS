//
//  GuessRoman71To80ResultVC.swift
//  KSchool
//
...
class GuessRoman71To80ResultVC: BaseViewController {
    ...
    func goToMenu(markCompleted: Bool = true) {
        ...
        if markCompleted {
            UserDefaults.standard.set(true, forKey: "romanNumeralsLevel9Completed")
            UserDefaults.standard.set(percentage, forKey: "romanNumeralsLevel9Percentage")
        }
