...
class GuessRoman1To10ShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessRoman1To10ResultVC"
        ) as? GuessRoman1To10ResultVC {
