...
class GuessRoman1To10ResultVC: BaseViewController {
    ...
    func goToMenu(markCompleted: Bool = true) {
        ...
        if markCompleted {
            UserDefaults.standard.set(true, forKey: "romanNumeralsLevel2Completed")
            UserDefaults.standard.set(percentage, forKey: "romanNumeralsLevel2Percentage")
        }
