//
//  PlanentOrderMatchResultLevel1VC.swift
//  Kids
//
...
class PlanentOrderMatchResultLevel1VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "planetsFactLevel1Completed")
        UserDefaults.standard.set(percentage, forKey: "planetsFactLevel1Percentage")

        if let menuVC = navigationController?.viewControllers.first(
            where: { $0 is PlanetsFactMenuVC }
