//
//  PlanentOrderMatchResultLevel3VC.swift
//  Kids
//
...
class PlanentOrderMatchResultLevel3VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "planetsFactLevel3Completed")
        UserDefaults.standard.set(percentage, forKey: "planetsFactLevel3Percentage")
