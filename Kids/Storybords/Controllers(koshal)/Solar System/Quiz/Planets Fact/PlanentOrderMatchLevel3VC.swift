//
//  PlanentOrderMatchLevel3VC.swift
//  Kids
//
...
class PlanentOrderMatchLevel3VC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    var quizQuestions: [PlanetQuizQuestion] = [
        ...
        PlanetQuizQuestion(
            question: "Does the Moon have air?".localiz(),
            options: ["No".localiz(), "Sometimes".localiz(), "Yes".localiz(), "Only at night".localiz()],
            correctAnswer: "No".localiz()
        ),

        PlanetQuizQuestion(
            question: "How often does Earth spin?".localiz(),
            options: ["Once a month".localiz(), "Once a week".localiz(), "Once a year".localiz(), "Once a day".localiz()],
            correctAnswer: "Once a day".localiz()
        ),

        PlanetQuizQuestion(
            question: "Does Mercury have moons?".localiz(),
            options: ["No".localiz(), "Two".localiz(), "Many".localiz(), "Yes".localiz()],
            correctAnswer: "No".localiz()
        ),

        PlanetQuizQuestion(
            question: "Which planet has many rings?".localiz(),
            options: ["Jupiter".localiz(), "Neptune".localiz(), "Uranus".localiz(), "Saturn".localiz()],
            correctAnswer: "Saturn".localiz()
        ),

        PlanetQuizQuestion(
            question: "Which planet has strong gravity?".localiz(),
            options: ["Venus".localiz(), "Earth".localiz(), "Jupiter".localiz(), "Mars".localiz()],
            correctAnswer: "Jupiter".localiz()
        ),

        PlanetQuizQuestion(
            question: "How many moons does Mars have?".localiz(),
            options: ["One".localiz(), "Four".localiz(), "Many".localiz(), "Two".localiz()],
            correctAnswer: "Two".localiz()
        ),

        PlanetQuizQuestion(
            question: "Which planet was discovered last in the solar system?".localiz(),
            options: ["Saturn".localiz(), "Jupiter".localiz(), "Uranus".localiz(), "Neptune".localiz()],
            correctAnswer: "Neptune".localiz()
        ),

        PlanetQuizQuestion(
            question: "What color is Uranus?".localiz(),
            options: ["Blue-green".localiz(), "Yellow".localiz(), "Brown".localiz(), "Red".localiz()],
            correctAnswer: "Blue-green".localiz()
        ),

        PlanetQuizQuestion(
            question: "What is the Sun?".localiz(),
            options: ["A moon".localiz(), "An asteroid".localiz(), "A planet".localiz(), "A star".localiz()],
            correctAnswer: "A star".localiz()
        ),

        PlanetQuizQuestion(
            question: "What covers Venus?".localiz(),
            options: ["Rings".localiz(), "Water".localiz(), "Ice".localiz(), "Thick clouds".localiz()],
            correctAnswer: "Thick clouds".localiz()
        )
    ]
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "PlanentOrderMatchResultLevel3VC"
        ) as? PlanentOrderMatchResultLevel3VC {
