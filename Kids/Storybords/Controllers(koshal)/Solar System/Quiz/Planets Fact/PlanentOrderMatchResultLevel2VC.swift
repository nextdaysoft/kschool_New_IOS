//
//  PlanentOrderMatchResultLevel2VC.swift
//  Kids
//
...
class PlanentOrderMatchResultLevel2VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "planetsFactLevel2Completed")
        UserDefaults.standard.set(percentage, forKey: "planetsFactLevel2Percentage")
