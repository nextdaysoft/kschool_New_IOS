//
//  PlanentOrderMatchResultLevel4VC.swift
//  Kids
//
...
class PlanentOrderMatchResultLevel4VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "planetsFactLevel4Completed")
        UserDefaults.standard.set(percentage, forKey: "planetsFactLevel4Percentage")
