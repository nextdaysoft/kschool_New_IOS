//
//  PlanentOrderMatchLevel4VC.swift
//  Kids
//
...
class PlanentOrderMatchLevel4VC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    var quizQuestions: [PlanetQuizQuestion] = [
        ...
        PlanetQuizQuestion(
            question: "How are Mercury’s temperatures?".localiz(),
            options: ["Extreme".localiz(), "Warm".localiz(), "Mild".localiz(), "Cold".localiz()],
            correctAnswer: "Extreme".localiz()
        ),

        PlanetQuizQuestion(
            question: "What color is Neptune?".localiz(),
            options: ["Brown".localiz(), "Green".localiz(), "Yellow".localiz(), "Dark blue".localiz()],
            correctAnswer: "Dark blue".localiz()
        ),

        PlanetQuizQuestion(
            question: "How does Venus spin?".localiz(),
            options: ["Normally".localiz(), "Very slowly".localiz(), "Very fast".localiz(), "Sideways".localiz()],
            correctAnswer: "Very slowly".localiz()
        ),

        PlanetQuizQuestion(
            question: "How many moons does Earth have?".localiz(),
            options: ["Two".localiz(), "Many".localiz(), "One".localiz(), "None".localiz()],
            correctAnswer: "One".localiz()
        ),

        PlanetQuizQuestion(
            question: "What storms does Mars have?".localiz(),
            options: ["Rain storms".localiz(), "Dust storms".localiz(), "Snow storms".localiz(), "Gas storms".localiz()],
            correctAnswer: "Dust storms".localiz()
        ),

        PlanetQuizQuestion(
            question: "What rings does Uranus have?".localiz(),
            options: ["Ice rings".localiz(), "Bright rings".localiz(), "No rings".localiz(), "Faint rings".localiz()],
            correctAnswer: "Faint rings".localiz()
        ),

        PlanetQuizQuestion(
            question: "How hot is the Sun?".localiz(),
            options: ["Cold".localiz(), "Very hot".localiz(), "Cool".localiz(), "Warm".localiz()],
            correctAnswer: "Very hot".localiz()
        ),

        PlanetQuizQuestion(
            question: "What type of planet is Jupiter?".localiz(),
            options: ["Ice".localiz(), "Metal".localiz(), "Rocky".localiz(), "Gas giant".localiz()],
            correctAnswer: "Gas giant".localiz()
        ),

        PlanetQuizQuestion(
            question: "Does the Moon change shape?".localiz(),
            options: ["Never".localiz(), "No".localiz(), "Sometimes".localiz(), "Yes".localiz()],
            correctAnswer: "Yes".localiz()
        ),

        PlanetQuizQuestion(
            question: "How is Saturn by weight?".localiz(),
            options: ["Medium".localiz(), "Solid".localiz(), "Very heavy".localiz(), "Very light".localiz()],
            correctAnswer: "Very light".localiz()
        )
    ]
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "PlanentOrderMatchResultLevel4VC"
        ) as? PlanentOrderMatchResultLevel4VC {
