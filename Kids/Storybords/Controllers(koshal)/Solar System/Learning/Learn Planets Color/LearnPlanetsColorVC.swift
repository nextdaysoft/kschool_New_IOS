...
class LearnPlanetsColorVC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Mercury is grey".localiz(),
            imageName: "image (1)"
        ),

        LearnPlanetsItem(
            text: "Venus is yellow".localiz(),
            imageName: "image (2)"
        ),

        LearnPlanetsItem(
            text: "Earth is blue and green".localiz(),
            imageName: "image9"
        ),

        LearnPlanetsItem(
            text: "Mars is red".localiz(),
            imageName: "image (3)"
        ),

        LearnPlanetsItem(
            text: "Jupiter is brown and orange".localiz(),
            imageName: "image (4)"
        ),

        LearnPlanetsItem(
            text: "Saturn is yellow and has rings".localiz(),
            imageName: "image (5)"
        ),

        LearnPlanetsItem(
            text: "Uranus is light blue".localiz(),
            imageName: "image (6)"
        ),

        LearnPlanetsItem(
            text: "Neptune is dark blue".localiz(),
            imageName: "image (7)"
        )
    ]
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnPlanetsColorResultVC"
        ) as? LearnPlanetsColorResultVC {
    ...
    func createFruitsPDF() -> URL? {
        ...
        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("PlanetsColor.pdf")
