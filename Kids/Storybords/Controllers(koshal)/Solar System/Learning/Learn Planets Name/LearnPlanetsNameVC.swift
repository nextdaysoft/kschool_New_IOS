...
class LearnPlanetsNameVC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(text: "Mercury".localiz(), imageName: "image (1)"),
        LearnPlanetsItem(text: "Venus".localiz(), imageName: "image (2)"),
        LearnPlanetsItem(text: "Earth".localiz(), imageName: "image9"),
        LearnPlanetsItem(text: "Mars".localiz(), imageName: "image (3)"),
        LearnPlanetsItem(text: "Jupiter".localiz(), imageName: "image (4)"),
        LearnPlanetsItem(text: "Saturn".localiz(), imageName: "image (5)"),
        LearnPlanetsItem(text: "Uranus".localiz(), imageName: "image (6)"),
        LearnPlanetsItem(text: "Neptune".localiz(), imageName: "image (7)")
    ]
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // Jo planets already dikh chuke
        let viewedPlanets = Array(planets.prefix(currentIndex + 1))

        // Remaining planets ko random karo
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnPlanetsNameResultVC"
        ) as? LearnPlanetsNameResultVC {
    ...
    func createFruitsPDF() -> URL? {
        ...
        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("PlanetsName.pdf")
