//
//  LearnPlanetsFactLevel4VC.swift
//  Kids
//
...
class LearnPlanetsFactLevel4VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Saturn is very light for its size".localiz(),
            imageName: "image (5)"
        ),

        LearnPlanetsItem(
            text: "Jupiter is a gas giant planet".localiz(),
            imageName: "image (4)"
        ),

        LearnPlanetsItem(
            text: "Neptune appears dark blue in color".localiz(),
            imageName: "image (7)"
        ),

        LearnPlanetsItem(
            text: "Mars has strong dust storms".localiz(),
            imageName: "image (3)"
        ),

        LearnPlanetsItem(
            text: "The Moon changes shape during the month".localiz(),
            imageName: "moon"
        ),

        LearnPlanetsItem(
            text: "Mercury has extreme temperatures".localiz(),
            imageName: "image (1)"
        ),

        LearnPlanetsItem(
            text: "Uranus has faint rings".localiz(),
            imageName: "image (6)"
        ),

        LearnPlanetsItem(
            text: "The Sun is extremely hot".localiz(),
            imageName: "image (8)"
        ),

        LearnPlanetsItem(
            text: "Venus spins very slowly".localiz(),
            imageName: "image (2)"
        ),

        LearnPlanetsItem(
            text: "Earth has one natural moon".localiz(),
            imageName: "image9"
        )
    ]
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // Keep already viewed items fixed
        let viewedPlanets = Array(planets.prefix(currentIndex + 1))

        // Shuffle only upcoming items
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnPlanetsFactResultLevel4VC"
        ) as? LearnPlanetsFactResultLevel4VC {
