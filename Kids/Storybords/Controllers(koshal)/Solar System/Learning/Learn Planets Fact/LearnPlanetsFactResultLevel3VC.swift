//
//  LearnPlanetsFactResultLevel3VC.swift
//  Kids
//
...
class LearnPlanetsFactResultLevel3VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "learnPlanetsFactLevel3Completed")
            if let menuVC = navigationController?.viewControllers.first(
                where: { $0 is LearnPlanetsFactMenuVC }
