//
//  LearnPlanetsFactResultLevel1VC.swift
//  Kids
//
...
class LearnPlanetsFactResultLevel1VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "learnPlanetsFactLevel1Completed")
