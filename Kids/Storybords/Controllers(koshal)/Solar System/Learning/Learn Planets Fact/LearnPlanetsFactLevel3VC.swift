//
//  LearnPlanetsFactLevel3VC.swift
//  Kids
//
...
class LearnPlanetsFactLevel3VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Neptune was the last planet discovered".localiz(),
            imageName: "image (7)"
        ),

        LearnPlanetsItem(
            text: "Venus has thick clouds".localiz(),
            imageName: "image (2)"
        ),

        LearnPlanetsItem(
            text: "Saturn has many rings".localiz(),
            imageName: "image (5)"
        ),

        LearnPlanetsItem(
            text: "Earth spins once every day".localiz(),
            imageName: "image9"
        ),

        LearnPlanetsItem(
            text: "Jupiter has very strong gravity".localiz(),
            imageName: "image (4)"
        ),

        LearnPlanetsItem(
            text: "Uranus looks blue-green in color".localiz(),
            imageName: "image (6)"
        ),

        LearnPlanetsItem(
            text: "Mercury has no moons".localiz(),
            imageName: "image (1)"
        ),

        LearnPlanetsItem(
            text: "The Moon has no air".localiz(),
            imageName: "moon"
        ),

        LearnPlanetsItem(
            text: "Mars has two small moons".localiz(),
            imageName: "image (3)"
        ),

        LearnPlanetsItem(
            text: "The Sun is a star at the center of the solar system".localiz(),
            imageName: "image (8)"
        )
    ]
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // Already visited cards preserve
        let viewedPlanets = Array(planets.prefix(currentIndex + 1))

        // Remaining cards shuffle again
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnPlanetsFactResultLevel3VC"
        ) as? LearnPlanetsFactResultLevel3VC {
