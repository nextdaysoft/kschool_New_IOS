//
//  LearnPlanetsFactResultLevel2VC.swift
//  Kids
//
...
class LearnPlanetsFactResultLevel2VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "learnPlanetsFactLevel2Completed")
