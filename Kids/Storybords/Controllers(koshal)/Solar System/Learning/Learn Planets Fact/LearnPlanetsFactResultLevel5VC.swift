//
//  LearnPlanetsFactResultLevel5VC.swift
//  Kids
//
...
class LearnPlanetsFactResultLevel5VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "learnPlanetsFactLevel5Completed")
