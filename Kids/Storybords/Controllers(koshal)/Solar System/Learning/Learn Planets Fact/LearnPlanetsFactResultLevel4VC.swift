//
//  LearnPlanetsFactResultLevel4VC.swift
//  Kids
//
...
class LearnPlanetsFactResultLevel4VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "learnPlanetsFactLevel4Completed")
