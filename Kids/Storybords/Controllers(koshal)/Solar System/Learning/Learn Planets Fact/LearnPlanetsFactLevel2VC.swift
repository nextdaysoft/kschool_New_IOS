//
//  LearnPlanetsFactLevel2VC.swift
//  Kids
//
...
class LearnPlanetsFactLevel2VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Uranus spins on its side".localiz(),
            imageName: "image (6)"
        ),

        LearnPlanetsItem(
            text: "Earth takes 365 days to orbit the Sun".localiz(),
            imageName: "image9"
        ),

        LearnPlanetsItem(
            text: "A day on Venus is longer than a year on Venus".localiz(),
            imageName: "image (2)"
        ),

        LearnPlanetsItem(
            text: "Saturn is less dense than water".localiz(),
            imageName: "image (5)"
        ),

        LearnPlanetsItem(
            text: "Mercury has the shortest year in the solar system".localiz(),
            imageName: "image (1)"
        ),

        LearnPlanetsItem(
            text: "Earth is the only planet known to support life".localiz(),
            imageName: "image9"
        ),

        LearnPlanetsItem(
            text: "The Moon takes about 27 days to orbit Earth".localiz(),
            imageName: "moon"
        ),

        LearnPlanetsItem(
            text: "Mars has the tallest volcano in the solar system".localiz(),
            imageName: "image (3)"
        ),

        LearnPlanetsItem(
            text: "Jupiter has a giant storm called the Great Red Spot".localiz(),
            imageName: "image (4)"
        ),

        LearnPlanetsItem(
            text: "Neptune has very fast winds".localiz(),
            imageName: "image (7)"
        )
    ]
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // Already viewed facts preserve
        let viewedFacts = Array(planets.prefix(currentIndex + 1))

        // Remaining facts shuffle again
        var remainingFacts = Array(planets.dropFirst(currentIndex + 1))
        remainingFacts.shuffle()

        // Rebuild sequence
        planets = viewedFacts + remainingFacts
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnPlanetsFactResultLevel2VC"
        ) as? LearnPlanetsFactResultLevel2VC {
