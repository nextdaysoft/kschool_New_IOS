//
//  LearnPlanetsFactLevel1VC.swift
//  Kids
//
...
class LearnPlanetsFactLevel1VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Earth is called the Blue Planet".localiz(),
            imageName: "image9"
        ),

        LearnPlanetsItem(
            text: "Earth is the planet we live on".localiz(),
            imageName: "image9"
        ),

        LearnPlanetsItem(
            text: "Saturn has beautiful rings".localiz(),
            imageName: "image (5)"
        ),

        LearnPlanetsItem(
            text: "Mercury is the smallest planet in the solar system".localiz(),
            imageName: "image (1)"
        ),

        LearnPlanetsItem(
            text: "Venus is the hottest planet in the solar system".localiz(),
            imageName: "image (2)"
        ),

        LearnPlanetsItem(
            text: "Neptune is the windiest planet in the solar system".localiz(),
            imageName: "image (7)"
        ),

        LearnPlanetsItem(
            text: "Neptune is the coldest planet in the solar system".localiz(),
            imageName: "image (7)"
        ),

        LearnPlanetsItem(
            text: "Saturn has the most moons in the solar system".localiz(),
            imageName: "image (5)"
        ),

        LearnPlanetsItem(
            text: "Mars is called the Red Planet".localiz(),
            imageName: "image (3)"
        ),

        LearnPlanetsItem(
            text: "Jupiter is the largest planet in the solar system".localiz(),
            imageName: "image (4)"
        )
    ]
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnPlanetsFactResultLevel1VC"
        ) as? LearnPlanetsFactResultLevel1VC {
