//
//  ShadowMatchGameLevel6ResultVC.swift
//  Kids
//
...
class ShadowMatchGameLevel6ResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        // 🔐 SAVE SHADOW MATCH LEVEL 6 RESULT
        UserDefaults.standard.set(true, forKey: "shadowMatchLevel6Completed")
        UserDefaults.standard.set(percentage, forKey: "shadowMatchLevel6Percentage")
