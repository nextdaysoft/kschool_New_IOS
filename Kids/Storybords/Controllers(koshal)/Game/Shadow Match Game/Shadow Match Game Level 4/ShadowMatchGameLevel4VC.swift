...
class ShadowMatchGameLevel4VC: BaseViewController {
    ...
    let animals = [
        ...
        (name: "deer", tag: 12),
        (name: "cat2", tag: 13),
        (name: "chimpanzee", tag: 14),
        (name: "kangaroo", tag: 15),
        (name: "shark", tag: 16),
        (name: "clown-fish", tag: 17),
        (name: "octopus", tag: 18),
        (name: "whale", tag: 19),
        (name: "rhinoceros", tag: 20),
        (name: "dolphin", tag: 21)
    ]
    ...
    // MARK: - Setup Images
    func setupImages() {
        img1.image = UIImage(named: "fox")
        img2.image = UIImage(named: "lion")
        img3.image = UIImage(named: "tiger")
        img4.image = UIImage(named: "wolf")
    ...
    func loadRandomShadow() {
        ...
        if currentQuestion > totalQuestions {
            ...
            let vc = storyboard.instantiateViewController(
                withIdentifier: "ShadowMatchGameLevel4ResultVC"
            ) as! ShadowMatchGameLevel4ResultVC
...
// MARK: - Drag Delegate
extension ShadowMatchGameLevel4VC: UIDragInteractionDelegate {
...
extension ShadowMatchGameLevel4VC: UIDropInteractionDelegate {
