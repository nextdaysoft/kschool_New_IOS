//
//  ShadowMatchGameLevel4ResultVC.swift
//  Find Pair
//
...
class ShadowMatchGameLevel4ResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        // 🔐 SAVE SHADOW MATCH LEVEL 4 RESULT
        UserDefaults.standard.set(true, forKey: "shadowMatchLevel4Completed")
        UserDefaults.standard.set(percentage, forKey: "shadowMatchLevel4Percentage")
