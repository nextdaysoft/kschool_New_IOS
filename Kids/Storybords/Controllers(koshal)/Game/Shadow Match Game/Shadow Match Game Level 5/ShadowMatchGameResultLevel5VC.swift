//
//  ShadowMatchGameResultLevel5VC.swift
//  Kids
//
...
class ShadowMatchGameResultLevel5VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        // 🔐 SAVE SHADOW MATCH LEVEL 5 RESULT
        UserDefaults.standard.set(true, forKey: "shadowMatchLevel5Completed")
        UserDefaults.standard.set(percentage, forKey: "shadowMatchLevel5Percentage")
