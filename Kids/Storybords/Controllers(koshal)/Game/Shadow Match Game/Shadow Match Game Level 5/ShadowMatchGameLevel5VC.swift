...
class ShadowMatchGameLevel5VC: BaseViewController {
    ...
    func setupImages() {
        ...
        img2.image = UIImage(named: "pig")
        img3.image = UIImage(named: "cow")
        img4.image = UIImage(named: "goat")
    ...
    func loadRandomShadow() {
        ...
        if currentQuestion > totalQuestions {
            ...
            let vc = storyboard.instantiateViewController(
                withIdentifier: "ShadowMatchGameResultLevel5VC"
            ) as! ShadowMatchGameResultLevel5VC
...
// MARK: - Drag Delegate
extension ShadowMatchGameLevel5VC: UIDragInteractionDelegate {
...
extension ShadowMatchGameLevel5VC: UIDropInteractionDelegate {
