...
class ShadowMatchGameLevel3VC: BaseViewController {
    ...
    let animals = [
        (name: "apple", tag: 1),
        (name: "avocado", tag: 2),
        (name: "strawberry", tag: 3),
        (name: "lemon", tag: 4),
        (name: "banana", tag: 5),
        (name: "grapes", tag: 6),
        (name: "mango", tag: 7),
        (name: "orange", tag: 8),
        (name: "watermelon", tag: 9),
    ...
    func loadRandomShadow() {
        ...
        if currentQuestion > totalQuestions {
            ...
            let vc = storyboard.instantiateViewController(
                withIdentifier: "ShadowMatchGameResultLevel3VC"
            ) as! ShadowMatchGameResultLevel3VC
...
// MARK: - Drag Delegate
extension ShadowMatchGameLevel3VC: UIDragInteractionDelegate {
...
extension ShadowMatchGameLevel3VC: UIDropInteractionDelegate {
