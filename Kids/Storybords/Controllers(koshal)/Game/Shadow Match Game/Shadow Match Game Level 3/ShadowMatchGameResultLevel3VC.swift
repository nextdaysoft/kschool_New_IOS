//
//  ShadowMatchGameLevel5ResultVC.swift
//  Find Pair
//
...
class ShadowMatchGameResultLevel3VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        // 🔐 SAVE SHADOW MATCH LEVEL 3 RESULT
        UserDefaults.standard.set(true, forKey: "shadowMatchLevel3Completed")
        UserDefaults.standard.set(percentage, forKey: "shadowMatchLevel3Percentage")
