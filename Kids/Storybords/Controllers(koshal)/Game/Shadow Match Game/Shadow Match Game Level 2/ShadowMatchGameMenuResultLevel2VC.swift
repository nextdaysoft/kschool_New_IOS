//
//  ShadowMatchGameMenuResultVC.swift
//  Find Pair
//
...
class ShadowMatchGameMenuResultLevel2VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        // 🔐 SAVE SHADOW MATCH LEVEL 2 RESULT
        UserDefaults.standard.set(true, forKey: "shadowMatchLevel2Completed")
        UserDefaults.standard.set(percentage, forKey: "shadowMatchLevel2Percentage")
