...
class ShadowMatchGameLevel2VC: BaseViewController {
    ...
    // MARK: - Game Data
    let animals = [
        (name: "schoolBus", tag: 1),
        (name: "policeCar", tag: 2),
        (name: "motorbike", tag: 3),
        (name: "deliver", tag: 4),
        (name: "bicycle", tag: 5),
        (name: "ambulance", tag: 6),
        (name: "boat", tag: 7),
        (name: "busLane", tag: 8),
        (name: "car", tag: 9),
        (name: "cruiseShip", tag: 10),
        (name: "dumpTruck", tag: 11),
        (name: "fighterJet", tag: 12),
        (name: "fireBrigade", tag: 13),
        (name: "helicopter", tag: 14),
        (name: "jetSki", tag: 15),
        (name: "submarine", tag: 16),
        (name: "travelling", tag: 17),
        (name: "airship", tag: 18),
    ]
    ...
    // MARK: - Setup Images
    func setupImages() {
        img1.image = UIImage(named: "bicycle")
        img2.image = UIImage(named: "deliver")
        img3.image = UIImage(named: "motorbike")
        img4.image = UIImage(named: "bus-lane")
    ...
    func loadRandomShadow() {
        ...
        if currentQuestion > totalQuestions {
            ...
            let vc = storyboard.instantiateViewController(
                withIdentifier: "ShadowMatchGameMenuResultLevel2VC"
            ) as! ShadowMatchGameMenuResultLevel2VC
...
// MARK: - Drag Delegate
extension ShadowMatchGameLevel2VC: UIDragInteractionDelegate {
...
extension ShadowMatchGameLevel2VC: UIDropInteractionDelegate {
