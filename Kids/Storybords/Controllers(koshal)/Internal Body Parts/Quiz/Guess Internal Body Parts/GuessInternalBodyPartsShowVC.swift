//
//  GuessInternalBodyPartsShowVC.swift
//  KSchool
//
...
class GuessInternalBodyPartsShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResult() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessInternalBodyPartsResultVC"
        ) as? GuessInternalBodyPartsResultVC {
