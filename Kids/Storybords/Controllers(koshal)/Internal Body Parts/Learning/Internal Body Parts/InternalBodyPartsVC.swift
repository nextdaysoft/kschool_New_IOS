...
class InternalBodyPartsVC: BaseViewController {
    ...
    let bodyParts: [BodyPart] = [
           BodyPart(name: "Brain", image: "brainNew"),
           BodyPart(name: "Heart", image: "heartBody"),
           BodyPart(name: "Lungs", image: "lungs"),
           BodyPart(name: "Stomach", image: "stomach"),
           BodyPart(name: "Liver", image: "liver"),
           BodyPart(name: "Kidney", image: "kidney"),
           BodyPart(name: "Intestines", image: "intestines"),
           BodyPart(name: "Bladder", image: "bladder"),
           BodyPart(name: "Pancreas", image: "pancreas")
       ]
    ...
    func createPDF() -> URL? {
        ...
        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("InternalBodyParts.pdf")
