...
class SetTimeMinutesResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "clockLevel5Completed")
        UserDefaults.standard.set(percentage, forKey: "clockLevel5Percentage")
