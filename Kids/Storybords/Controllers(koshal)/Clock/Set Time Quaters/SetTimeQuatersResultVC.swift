...
class SetTimeQuatersResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "clockLevel3Completed")
        UserDefaults.standard.set(percentage, forKey: "clockLevel3Percentage")
