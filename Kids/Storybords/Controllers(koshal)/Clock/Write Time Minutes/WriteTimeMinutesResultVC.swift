//
//  WriteTimeMinutesResultVC.swift
//  Kids
//
...
class WriteTimeMinutesResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "clockLevel6Completed")
        UserDefaults.standard.set(percentage, forKey: "clockLevel6Percentage")
