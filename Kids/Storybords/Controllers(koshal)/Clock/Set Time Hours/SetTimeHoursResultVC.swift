...
class SetTimeHoursResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "clockLevel1Completed")
        UserDefaults.standard.set(percentage, forKey: "clockLevel1Percentage")
