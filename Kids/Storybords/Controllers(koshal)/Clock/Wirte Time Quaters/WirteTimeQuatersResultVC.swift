//
//  WirteTimeQuatersResultVC.swift
//  Kids
//
...
class WirteTimeQuatersResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "clockLevel4Completed")
        UserDefaults.standard.set(percentage, forKey: "clockLevel4Percentage")
