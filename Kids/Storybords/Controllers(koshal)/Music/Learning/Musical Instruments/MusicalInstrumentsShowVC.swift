//
//  MusicalInstrumentsShowVC.swift
//  KSchool
//
...
class MusicalInstrumentsShowVC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func showSwipeUpHint() {
        ...
        let label = UILabel()
        label.text = "Swipe up to change musical instruments"
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // Already visited same rahenge
        let viewedItems = Array(planets[0...currentIndex])

        // Aage wale dobara random
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "MusicalInstrumentsResultVC"
        ) as? MusicalInstrumentsResultVC {
    ...
    func createFruitsPDF() -> URL? {
        ...
        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("MusicalInstruments.pdf")
