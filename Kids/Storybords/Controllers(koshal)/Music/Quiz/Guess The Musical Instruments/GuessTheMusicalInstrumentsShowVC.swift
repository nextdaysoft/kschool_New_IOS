//
//  GuessTheMusicalInstrumentsShowVC.swift
//  KSchool
//
...
class GuessTheMusicalInstrumentsShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResult() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessTheMusicalInstrumentsResultVC"
        ) as? GuessTheMusicalInstrumentsResultVC {
