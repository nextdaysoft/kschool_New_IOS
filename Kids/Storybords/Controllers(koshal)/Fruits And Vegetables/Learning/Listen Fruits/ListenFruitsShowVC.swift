...
class ListenFruitsShowVC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func showSwipeUpHint() {
        ...
        let label = UILabel()
        label.text = "Swipe up to change fruits"
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // Sirf remaining ko shuffle karo
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "ListenFruitsResultVC"
        ) as? ListenFruitsResultVC {
    ...
    func createFruitsPDF() -> URL? {
        ...
        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("Fruits.pdf")
