//
//  GuessTheVegetablesShowVC.swift
//  Kids
//
...
class GuessTheVegetablesShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResult() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessTheVegetablesResultVC"
        ) as? GuessTheVegetablesResultVC {
