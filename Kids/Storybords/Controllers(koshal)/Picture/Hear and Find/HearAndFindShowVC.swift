...
class HearAndFindShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    @IBOutlet weak var nameOfImgLabel: UILabel!
    
    @IBOutlet weak var nameOfImgLabelBGView: UIView!
    ...
    override func viewDidLoad() {
        ...
        nameOfImgLabelBGView.layer.cornerRadius = 6
    ...
    func setupQuestion() {
        ...
        nameOfImgLabel.text = currentBird.name
    ...
    func goToResult() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "HearAndFindResultVC"
        ) as? HearAndFindResultVC {
