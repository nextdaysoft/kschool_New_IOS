//
//  FillTheMissingLetterResultLevel6VC.swift
//  Kids
//
...
class FillTheMissingLetterResultLevel6VC: BaseViewController {
    ...
    @IBOutlet weak var statusView: UIView!
     ...
     var results: [QuestionResultsLevel6] = []
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "fillMissingLevel6Completed")
        UserDefaults.standard.set(percentage, forKey: "fillMissingLevel6Percentage")
