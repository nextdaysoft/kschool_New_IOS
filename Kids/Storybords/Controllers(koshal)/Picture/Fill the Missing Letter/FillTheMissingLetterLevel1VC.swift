...
class FillTheMissingLetterLevel1VC: BaseViewController {
    ...
    @IBAction func nextAndSubmitTapBtn(_ sender: UIButton) {
        ...
        if !isSubmitted {
            ...
            let result = QuestionResultsLevel1(
        ...
        if currentIndex < wordsData.count {
            ...
            let vc = storyboard.instantiateViewController(
                withIdentifier: "FillTheMissingLetterResultLevel1VC"
            ) as! FillTheMissingLetterResultLevel1VC
