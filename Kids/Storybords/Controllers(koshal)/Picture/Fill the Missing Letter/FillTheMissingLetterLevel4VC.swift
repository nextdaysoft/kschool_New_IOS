//
//  FillTheMissingLetterLevel4VC.swift
//  Kids
//
...
class FillTheMissingLetterLevel4VC: BaseViewController {
    ...
    @IBAction func nextAndSubmitTapBtn(_ sender: UIButton) {
        ...
        if !isSubmitted {
            ...
            let result = QuestionResultsLevel4(
        ...
        if currentIndex < wordsData.count {
            ...
            let vc = storyboard.instantiateViewController(
                withIdentifier: "FillTheMissingLetterResultLevel4VC"
            ) as! FillTheMissingLetterResultLevel4VC
