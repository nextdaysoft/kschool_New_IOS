//
//  FillTheMissingLetterResultLevel2VC.swift
//  Kids
//
...
class FillTheMissingLetterResultLevel2VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "fillMissingLevel2Completed")
        UserDefaults.standard.set(percentage, forKey: "fillMissingLevel2Percentage")
