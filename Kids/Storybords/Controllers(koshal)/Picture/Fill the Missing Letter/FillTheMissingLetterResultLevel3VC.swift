//
//  FillTheMissingLetterResultLevel3VC.swift
//  Kids
//
...
class FillTheMissingLetterResultLevel3VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "fillMissingLevel3Completed")
        UserDefaults.standard.set(percentage, forKey: "fillMissingLevel3Percentage")
