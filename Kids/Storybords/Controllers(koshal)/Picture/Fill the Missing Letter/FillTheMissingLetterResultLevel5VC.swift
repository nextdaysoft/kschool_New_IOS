//
//  FillTheMissingLetterResultLevel5VC.swift
//  Kids
//
...
class FillTheMissingLetterResultLevel5VC: BaseViewController {
    ...
    var results: [QuestionResultsLevel5] = []
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "fillMissingLevel5Completed")
        UserDefaults.standard.set(percentage, forKey: "fillMissingLevel5Percentage")
