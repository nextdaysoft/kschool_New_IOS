//
//  FillTheMissingLetterLevel5VC.swift
//  Kids
//
//  Created by Koshal Singh on 22/01/26.
//
import LanguageManager_iOS
struct QuestionResultsLevel5 {
...
class FillTheMissingLetterLevel5VC: BaseViewController {
    ...
    @IBAction func nextAndSubmitTapBtn(_ sender: UIButton) {
        ...
        if !isSubmitted {
            ...
            let result = QuestionResultsLevel5(
        ...
        if currentIndex < wordsData.count {
            ...
            let vc = storyboard.instantiateViewController(
                withIdentifier: "FillTheMissingLetterResultLevel5VC"
            ) as! FillTheMissingLetterResultLevel5VC
