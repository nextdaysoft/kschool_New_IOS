//
//  FillTheMissingLetterResultLevel4VC.swift
//  Kids
//
...
class FillTheMissingLetterResultLevel4VC: BaseViewController {
    ...
    var results: [QuestionResultsLevel4] = []
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "fillMissingLevel4Completed")
        UserDefaults.standard.set(percentage, forKey: "fillMissingLevel4Percentage")
