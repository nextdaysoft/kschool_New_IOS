//
//  FillTheMissingLetterLevel6VC.swift
//  Kids
//
...
class FillTheMissingLetterLevel6VC: BaseViewController {
    ...
    @IBAction func nextAndSubmitTapBtn(_ sender: UIButton) {
        ...
        if !isSubmitted {
            ...
            let result = QuestionResultsLevel6(
        ...
        if currentIndex < wordsData.count {
            ...
            let vc = storyboard.instantiateViewController(
                withIdentifier: "FillTheMissingLetterResultLevel6VC"
            ) as! FillTheMissingLetterResultLevel6VC
