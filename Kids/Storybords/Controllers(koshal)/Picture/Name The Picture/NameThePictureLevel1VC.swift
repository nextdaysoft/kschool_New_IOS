...
class NameThePictureLevel1VC: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        correctMapping = [
            appleView: "Apple".localiz(),
            ballView: "Ball".localiz(),
            catView: "Cat".localiz(),
            dogView: "Dog".localiz(),
            sunView: "Sun".localiz()
        ]
    ...
    func undoLastPlacement() {
        ...
        if let sourceView = labelSourceMap[label] {
            ...
            label.isUserInteractionEnabled = true   // 🔓 unlock on undo
    ...
    @IBAction func undoAndNextapBtn(_ sender: UIButton) {
        ...
        UserDefaults.standard.set(true, forKey: "nameThePictureLevel1Completed")
        UserDefaults.standard.set(percentage, forKey: "nameThePictureLevel1Percentage")
