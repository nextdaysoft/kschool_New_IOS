...
class NameThePictureLevel2VC: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        correctMapping = [
            dropView1: "Chair".localiz(),
            dropView2: "Table".localiz(),
            dropView3: "Bed".localiz(),
            dropView4: "Cup".localiz(),
            dropView5: "Clock".localiz()
        ]
    ...
    @IBAction func undoAndNextapBtn(_ sender: UIButton) {
        ...
        UserDefaults.standard.set(true, forKey: "nameThePictureLevel2Completed")
        UserDefaults.standard.set(percentage, forKey: "nameThePictureLevel2Percentage")
