...
class NameThePictureLevel4VC: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        correctMapping = [
            dropView1: "Car".localiz(),
            dropView2: "Bus".localiz(),
            dropView3: "Train".localiz(),
            dropView4: "Airplane".localiz(),
            dropView5: "Boat".localiz()
        ]
    ...
    @IBAction func undoAndNextapBtn(_ sender: UIButton) {
        ...
        UserDefaults.standard.set(true, forKey: "nameThePictureLevel4Completed")
        UserDefaults.standard.set(percentage, forKey: "nameThePictureLevel4Percentage")
