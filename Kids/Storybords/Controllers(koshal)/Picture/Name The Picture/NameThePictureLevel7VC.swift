...
class NameThePictureLevel7VC: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        correctMapping = [
            dropView1: "Fish".localiz(),
            dropView2: "Door".localiz(),
            dropView3: "Leaf".localiz(),
            dropView4: "Leaf".localiz(),
            dropView5: "Bicycle".localiz()
        ]
    ...
    @IBAction func undoAndNextapBtn(_ sender: UIButton) {
        ...
        UserDefaults.standard.set(true, forKey: "nameThePictureLevel7Completed")
        UserDefaults.standard.set(percentage, forKey: "nameThePictureLevel7Percentage")

        if let menuVC = navigationController?.viewControllers.first(
            where: { $0 is NameThePictureMenuVC }
        ) as? NameThePictureMenuVC {

            menuVC.receivedPercentage7 = percentage
            menuVC.receivedImage7 = UIImage(named: "well-done")
        }
