...
class NameThePictureLevel6VC: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        correctMapping = [
            dropView1: "Rainbow".localiz(),
            dropView2: "Butterfly".localiz(),
            dropView3: "House".localiz(),
            dropView4: "Truck".localiz(),
            dropView5: "Sunflower".localiz()
        ]
    ...
    @IBAction func undoAndNextapBtn(_ sender: UIButton) {
        ...
        UserDefaults.standard.set(true, forKey: "nameThePictureLevel6Completed")
        UserDefaults.standard.set(percentage, forKey: "nameThePictureLevel6Percentage")
