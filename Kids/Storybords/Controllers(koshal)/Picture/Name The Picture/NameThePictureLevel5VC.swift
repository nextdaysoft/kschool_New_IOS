...
class NameThePictureLevel5VC: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        correctMapping = [
            dropView1: "Elephant".localiz(),
            dropView2: "Lion".localiz(),
            dropView3: "Monkey".localiz(),
            dropView4: "Cow".localiz(),
            dropView5: "Rabbit".localiz()
        ]
    ...
    @IBAction func undoAndNextapBtn(_ sender: UIButton) {
        ...
        UserDefaults.standard.set(true, forKey: "nameThePictureLevel5Completed")
        UserDefaults.standard.set(percentage, forKey: "nameThePictureLevel5Percentage")
