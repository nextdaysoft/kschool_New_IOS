...
class MatchImageWithLetterLevel1VC: BaseViewController {
    ...
    // MARK: - Setup Methods
    func setupLabels() {
        let letters = ["A", "B", "C", "D", "E"].shuffled()
    ...
    @IBAction func submitAndNextTapBtn(_ sender: UIButton) {
        ...
        if isSubmitted {
            ...
            UserDefaults.standard.set(true, forKey: "matchImageLetterLevel1Completed")
            UserDefaults.standard.set(percentage, forKey: "matchImageLetterLevel1Percentage")
