//
//  MatchImageWithLetterLevel6VC.swift
//  Kids
//
...
class MatchImageWithLetterLevel6VC: BaseViewController {
    ...
    // MARK: - Setup Methods
    func setupLabels() {
        let letters = ["Z", "A", "B", "C", "D"].shuffled()
    ...
    @IBAction func submitAndNextTapBtn(_ sender: UIButton) {
        ...
        if isSubmitted {
            ...
            // 🔐 SAVE MATCH IMAGE WITH LETTER – LEVEL 6
            UserDefaults.standard.set(true, forKey: "matchImageLetterLevel6Completed")
            UserDefaults.standard.set(percentage, forKey: "matchImageLetterLevel6Percentage")
            ...
            if let menuVC = navigationController?.viewControllers.first(
                ...
                menuVC.receivedPercentage6 = percentage
                menuVC.receivedImage6 = UIImage(named: "well-done")
