...
class LearnBloodGroupsMenuVC: BaseViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let isCompleted2 = UserDefaults.standard.bool(forKey: "learnBloodGroupsLevel2Completed")
           let percentage2 = UserDefaults.standard.integer(forKey: "learnBloodGroupsLevel2Percentage")
    ...
    func updateResetVisibility() {
        ...
        UserDefaults.standard.bool(forKey: "learnBloodGroupsLevel2Completed")
    ...
    func setupSubscriptionLock() {
        ...
        UserDefaults.standard.bool(
            forKey: "learnBloodGroupsLevel2Completed"
        )

        let percentage =
        UserDefaults.standard.integer(
            forKey: "learnBloodGroupsLevel2Percentage"
        )
    ...
    @IBAction func level1TapBtn(_ sender: UIButton) {
        ...
        let vc = storyboard.instantiateViewController(
            withIdentifier: "LearnIBloodGroupsVC"
        ) as! LearnIBloodGroupsVC
    ...
    @IBAction func level2TapBtn(_ sender: UIButton) {
        ...
        let vc = storyboard.instantiateViewController(
            withIdentifier: "BloodDonationShowVC"
        ) as! BloodDonationShowVC
