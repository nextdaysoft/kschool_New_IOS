...
class BloodDonationShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    var capacityUnitQuestions: [WeightUnitQuestion] = [
        ...
        WeightUnitQuestion(
            question: "Which blood group can receive from all other groups?",
            options: ["B-", "AB+", "A+", "O-"],
            correctAnswer: "AB+"
        ),

        WeightUnitQuestion(
            question: "Which blood group donates to everyone?",
            options: ["O-", "AB+", "A+", "B+"],
            correctAnswer: "O-"
        ),

        WeightUnitQuestion(
            question: "Which blood group donates to O+, A+, B+, and AB+?",
            options: ["AB-", "B-", "A-", "O+"],
            correctAnswer: "O+"
        ),

        WeightUnitQuestion(
            question: "Which blood group donates to both AB- and AB+ only?",
            options: ["AB-", "A-", "B-", "O+"],
            correctAnswer: "AB-"
        ),

        WeightUnitQuestion(
            question: "Which blood group donates to A+ and AB+?",
            options: ["A+", "B+", "AB+", "AB-"],
            correctAnswer: "A+"
        ),
        ...
        WeightUnitQuestion(
            question: "Which blood group donates only to AB+?",
            options: ["AB+", "A+", "O+", "B+"],
            correctAnswer: "AB+"
        ),

        WeightUnitQuestion(
            question: "Which blood group donates to A+, A-, AB+, and AB-?",
            options: ["O+", "AB+", "B+", "A-"],
            correctAnswer: "A-"
        ),

        WeightUnitQuestion(
            question: "Which blood group donates to B+ and AB+?",
            options: ["AB+", "A+", "AB-", "B+"],
            correctAnswer: "B+"
        ),

        WeightUnitQuestion(
            question: "Which blood group donates to B+, B-, AB+, and AB-?",
            options: ["AB+", "O+", "A+", "B-"],
            correctAnswer: "B-"
        )
    ]
        ...
        if selectedAnswer == correctAnswer {
            ...
            for (i, label) in labels.enumerated() {
                if label?.text == correctAnswer {
                    views[i]?.backgroundColor = UIColor.systemGreen
                }
            }
        }
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "BloodDonationResultVC"
        ) as? BloodDonationResultVC {
