//
//  GuessTheInformationalSignsShowVC.swift
//  KSchool
//
...
class GuessTheInformationalSignsShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResult() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessTheInformationalSignsResultVC"
        ) as? GuessTheInformationalSignsResultVC {
