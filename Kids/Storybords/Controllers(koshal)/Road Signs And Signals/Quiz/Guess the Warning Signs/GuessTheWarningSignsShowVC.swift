//
//  GuessTheWarningSignsShowVC.swift
//  KSchool
//
...
class GuessTheWarningSignsShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResult() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessTheWarningSignsResultVC"
        ) as? GuessTheWarningSignsResultVC {
