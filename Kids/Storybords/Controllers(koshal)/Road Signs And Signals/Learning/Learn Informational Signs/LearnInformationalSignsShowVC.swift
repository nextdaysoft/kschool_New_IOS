//
//  LearnInformationalSignsShowVC.swift
//  KSchool
//
...
class LearnInformationalSignsShowVC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnInformationalSignsResultVC"
        ) as? LearnInformationalSignsResultVC {
    ...
    func createFruitsPDF() -> URL? {
        ...
        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("InformationalSigns.pdf")
