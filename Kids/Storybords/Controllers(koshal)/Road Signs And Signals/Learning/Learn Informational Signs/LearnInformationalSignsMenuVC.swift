//
//  LearnInformationalSignsMenuVC.swift
//  KSchool
//
...
class LearnInformationalSignsMenuVC: BaseViewController {
    ...
    func updateResetVisibility() {
        ...
        let isAnyCompleted =
            UserDefaults.standard.bool(forKey: "learnInformationalSignsLevel1Completed") ||
            UserDefaults.standard.bool(forKey: "learnInformationalSignsLevel2Completed") ||
            UserDefaults.standard.bool(forKey: "learnInformationalSignsLevel3Completed")
    ...
    func updateLevelUI(level: Int, imageView: UIImageView) {
        ...
        let completedKey = "learnInformationalSignsLevel\(level)Completed"
    ...
    @IBAction func level1TapBtn(_ sender: UIButton) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "LearnInformationalSignsShowVC") as! LearnInformationalSignsShowVC
        vc.planets = planets1
        vc.levelNumber = 1
    ...
    @IBAction func restTapBtn(_ sender: UIButton) {
        ...
        for i in 1...3 {
            defaults.removeObject(forKey: "learnInformationalSignsLevel\(i)Completed")
        }
