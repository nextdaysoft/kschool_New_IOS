//
//  LearnRegulatorySignsMenuVC.swift
//  KSchool
//
...
class LearnRegulatorySignsMenuVC: BaseViewController {
    ...
    func updateResetVisibility() {
        ...
        let isAnyCompleted =
            UserDefaults.standard.bool(forKey: "learnRegulatorySignsLevel1Completed") ||
            UserDefaults.standard.bool(forKey: "learnRegulatorySignsLevel2Completed") ||
            UserDefaults.standard.bool(forKey: "learnRegulatorySignsLevel3Completed")
    ...
    func updateLevelUI(level: Int, imageView: UIImageView) {
        ...
        let completedKey = "learnRegulatorySignsLevel\(level)Completed"
    ...
    @IBAction func level1TapBtn(_ sender: UIButton) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "LearnRegulatorySignsShowVC") as! LearnRegulatorySignsShowVC
        vc.planets = planets1
        vc.levelNumber = 1
    ...
    @IBAction func restTapBtn(_ sender: UIButton) {
        ...
        for i in 1...3 {
            defaults.removeObject(forKey: "learnRegulatorySignsLevel\(i)Completed")
        }
