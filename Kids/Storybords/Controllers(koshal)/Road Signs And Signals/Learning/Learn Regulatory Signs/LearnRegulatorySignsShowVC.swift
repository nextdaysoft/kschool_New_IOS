//
//  LearnRegulatorySignsShowVC.swift
//  KSchool
//
...
class LearnRegulatorySignsShowVC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnRegulatorySignsResultVC"
        ) as? LearnRegulatorySignsResultVC {
    ...
    func createFruitsPDF() -> URL? {
        ...
        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("RegulatorySigns.pdf")
