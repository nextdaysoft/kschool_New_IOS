...
class LearnWarningSignMenuVC: BaseViewController {
    ...
    func updateResetVisibility() {
        ...
        let isAnyCompleted =
            UserDefaults.standard.bool(forKey: "learnWarningSignLevel1Completed") ||
            UserDefaults.standard.bool(forKey: "learnWarningSignLevel2Completed") ||
            UserDefaults.standard.bool(forKey: "learnWarningSignLevel3Completed") ||
            UserDefaults.standard.bool(forKey: "learnWarningSignLevel4Completed")
    ...
    func updateLevelUI(level: Int, imageView: UIImageView) {
        ...
        let completedKey = "learnWarningSignLevel\(level)Completed"
    ...
    func setupSubscriptionLock() {
        ...
        for (level,image,bg) in levels {
            ...
            UserDefaults.standard.bool(
                forKey: "learnWarningSignLevel\(level)Completed"
            )
    ...
    @IBAction func level1TapBtn(_ sender: UIButton) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "LearnWarningSignShowVC") as! LearnWarningSignShowVC
        vc.planets = planets1
        vc.levelNumber = 1
    ...
    @IBAction func level3TapBtn(_ sender: UIButton) {
        ...
        let vc = storyboard?.instantiateViewController(
            withIdentifier: "LearnWarningSignShowVC"
        ) as! LearnWarningSignShowVC
    ...
    @IBAction func restTapBtn(_ sender: UIButton) {
        ...
        for i in 1...4 {
            ...
            defaults.removeObject(
                forKey: "learnWarningSignLevel\(i)Completed"
            )
        }
