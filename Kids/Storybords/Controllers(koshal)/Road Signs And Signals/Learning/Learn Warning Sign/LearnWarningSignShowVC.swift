...
class LearnWarningSignShowVC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func showSwipeUpHint() {
        ...
        let label = UILabel()
        label.text = "Swipe up to change signs"
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // ✅ Jo already dekh liye unko preserve rakho
        let viewedItems = Array(
            planets.prefix(currentIndex + 1)
        )

        // ✅ Sirf remaining items reshuffle honge
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnWarningSignResultVC"
        ) as? LearnWarningSignResultVC {
    ...
    func createFruitsPDF() -> URL? {
        ...
        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("WarningSign.pdf")
