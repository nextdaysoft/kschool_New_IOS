//
//  LearnWeightUnitConversionResultVC.swift
//  KSchool
//
...
class LearnWeightUnitConversionResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "measurementLevel2Completed")
