//
//  LearnWeightUnitConversionShowVC.swift
//  KSchool
//
...
class LearnWeightUnitConversionShowVC: BaseViewController,AVSpeechSynthesizerDelegate  {
    ...
    func showSwipeUpHint() {
        ...
        let label = UILabel()
        label.text = "Swipe up to change weight unit conversion"
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnWeightUnitConversionResultVC"
        ) as? LearnWeightUnitConversionResultVC {
    ...
    func createWeightUnitConversionPDF() -> URL? {

        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("WeightUnitConversion.pdf")
        ...
        do {
            ...
            try renderer.writePDF(to: pdfURL) { context in
                ...
                let title = "Weight Unit Conversion"
    ...
    @IBAction func pdfTapBtn(_ sender: UIButton) {
        ...
        guard let pdfURL = createWeightUnitConversionPDF() else { return }
