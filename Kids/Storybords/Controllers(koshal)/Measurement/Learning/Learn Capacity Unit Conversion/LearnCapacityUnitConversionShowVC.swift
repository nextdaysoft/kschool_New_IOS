//
//  LearnCapacityUnitConversionShowVC.swift
//  KSchool
//
...
class LearnCapacityUnitConversionShowVC: BaseViewController,AVSpeechSynthesizerDelegate  {
    ...
    func showSwipeUpHint() {
        ...
        let label = UILabel()
        label.text = "Swipe up to change capacity unit conversion"
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnCapacityUnitConversionResultVC"
        ) as? LearnCapacityUnitConversionResultVC {
