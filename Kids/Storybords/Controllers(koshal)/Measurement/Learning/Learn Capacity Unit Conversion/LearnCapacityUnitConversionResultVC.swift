//
//  LearnCapacityUnitConversionResultVC.swift
//  KSchool
//
...
class LearnCapacityUnitConversionResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "measurementLevel7Completed")
