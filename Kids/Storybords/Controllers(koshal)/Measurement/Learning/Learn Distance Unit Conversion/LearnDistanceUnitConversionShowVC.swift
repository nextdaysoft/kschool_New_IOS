//
//  LearnDistanceUnitConversionShowVC.swift
//  KSchool
//
...
class LearnDistanceUnitConversionShowVC: BaseViewController,AVSpeechSynthesizerDelegate  {
    ...
    func showSwipeUpHint() {
        ...
        let label = UILabel()
        label.text = "Swipe up to change distance unit conversion"
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnDistanceUnitConversionResultVC"
        ) as? LearnDistanceUnitConversionResultVC {
    ...
    func createDistanceUnitConversionPDF() -> URL? {

        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("DistanceUnitConversion.pdf")
        ...
        do {
            ...
            try renderer.writePDF(to: pdfURL) { context in
                ...
                let title = "Distance Unit Conversion"
    ...
    @IBAction func pdfTapBtn(_ sender: UIButton) {
        ...
        guard let pdfURL = createDistanceUnitConversionPDF() else { return }
