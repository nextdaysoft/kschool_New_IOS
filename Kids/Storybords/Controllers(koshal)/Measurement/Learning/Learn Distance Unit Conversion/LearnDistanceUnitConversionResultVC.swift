//
//  LearnDistanceUnitConversionResultVC.swift
//  KSchool
//
...
class LearnDistanceUnitConversionResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "measurementLevel4Completed")
