//
//  LearnDistanceUnitsShowVC.swift
//  KSchool
//
...
class LearnDistanceUnitsShowVC: BaseViewController,AVSpeechSynthesizerDelegate  {
    ...
    func showSwipeUpHint() {
        ...
        let label = UILabel()
        label.text = "Swipe up to change distance units"
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnDistanceUnitsResultVC"
        ) as? LearnDistanceUnitsResultVC {
    ...
    func createDistanceUnitsPDF() -> URL? {

        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("DistanceUnits.pdf")
    ...
    @IBAction func pdfTapBtn(_ sender: UIButton) {
        ...
        guard let pdfURL = createDistanceUnitsPDF() else { return }
