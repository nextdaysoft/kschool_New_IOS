//
//  LearnCapacityUnitsShowVC.swift
//  KSchool
//
...
class LearnCapacityUnitsShowVC: BaseViewController,AVSpeechSynthesizerDelegate  {
    ...
    func showSwipeUpHint() {
        ...
        let label = UILabel()
        label.text = "Swipe up to change capacity units"
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnCapacityUnitsResultVC"
        ) as? LearnCapacityUnitsResultVC {
    ...
    func createCapacityUnitsPDF() -> URL? {

        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("CapacityUnits.pdf")
    ...
    @IBAction func pdfTapBtn(_ sender: UIButton) {
        ...
        guard let pdfURL = createCapacityUnitsPDF() else { return }
