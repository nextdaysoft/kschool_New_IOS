//
//  GuessTheCapacityUnitResultVC.swift
//  KSchool
//
...
class GuessTheCapacityUnitResultVC: BaseViewController {
    ...
    func goToMenu(markCompleted: Bool = true) {
        ...
        if markCompleted {
            UserDefaults.standard.set(true, forKey: "measurementLevel10Completed")
            UserDefaults.standard.set(percentage, forKey: "measurementLevel10Percentage")
        }
        ...
        if let menuVC = navigationController?.viewControllers.first(
            ...
            menuVC.level10Percentage = percentage
