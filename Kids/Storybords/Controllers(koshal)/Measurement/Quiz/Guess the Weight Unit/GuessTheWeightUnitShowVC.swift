//
//  GuessTheWeightUnitShowVC.swift
//  KSchool
//
//  Created by Koshal Singh on 03/04/26.
//
struct WeightUnitQuestion {
    let question: String
    let options: [String]
...
class GuessTheWeightUnitShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    var weightUnitQuestions: [WeightUnitQuestion] = [
        ...
        WeightUnitQuestion(
            question: "1 pound is equal to?",
            options: ["1000 grams (g)", "453.592 grams (g)", "100 grams (g)", "28.3495 grams (g)"],
            correctAnswer: "453.592 grams (g)"
        ),

        WeightUnitQuestion(
            question: "1 tonne is equal to?",
            options: ["1000 gram (g)", "100 kilogram (kg)", "100 quintal (q)", "10 quintal (q)"],
            correctAnswer: "10 quintal (q)"
        ),

        WeightUnitQuestion(
            question: "1 milligram is equal to?",
            options: ["1000 gram (g)", "1000 milligram (mg)", "100 microgram (µg)", "1000 microgram (µg)"],
            correctAnswer: "1000 microgram (µg)"
        ),

        WeightUnitQuestion(
            question: "Which symbol represents microgram?",
            options: ["µg", "kg", "q", "g"],
            correctAnswer: "µg"
        ),

        WeightUnitQuestion(
            question: "Which is the smallest weight unit?",
            options: ["Kilogram (kg)", "Milligram (mg)", "Gram (g)", "Microgram (µg)"],
            correctAnswer: "Microgram (µg)"
        ),

        WeightUnitQuestion(
            question: "1 kilogram is equal to?",
            options: ["1000 milligram (mg)", "100 gram (g)", "1000 kilogram (kg)", "1000 gram (g)"],
            correctAnswer: "1000 gram (g)"
        ),

        WeightUnitQuestion(
            question: "1 gram is equal to?",
            options: ["100 gram (g)", "1000 microgram (µg)", "1000 milligram (mg)", "1000 kilogram (kg)"],
            correctAnswer: "1000 milligram (mg)"
        ),

        WeightUnitQuestion(
            question: "1 ounce is equal to?",
            options: ["100 gram (g)", "453.592 grams (g)", "28.3495 grams (g)", "1000 grams (g)"],
            correctAnswer: "28.3495 grams (g)"
        ),

        WeightUnitQuestion(
            question: "1 quintal is equal to?",
            options: ["10 kilogram (kg)", "1000 kilogram (kg)", "1000 gram (g)", "100 kilogram (kg)"],
            correctAnswer: "100 kilogram (kg)"
        ),

        WeightUnitQuestion(
            question: "Which is the largest weight unit?",
            options: ["Kilogram (kg)", "Quintal (q)", "Pound (lb)", "Tonne (t)"],
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessTheWeightUnitResultVC"
        ) as? GuessTheWeightUnitResultVC {
