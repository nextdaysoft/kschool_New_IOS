...
class HerbivoresLevel4VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "HerbivoresResultLevel4VC"
        ) as? HerbivoresResultLevel4VC {
