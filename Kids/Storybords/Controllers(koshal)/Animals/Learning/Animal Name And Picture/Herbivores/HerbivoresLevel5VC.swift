...
class HerbivoresLevel5VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "HerbivoresResultLevel5VC"
        ) as? HerbivoresResultLevel5VC {
