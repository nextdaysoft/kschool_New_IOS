...
class HerbivoresLevel1VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "HerbivoresResultLevel1VC"
        ) as? HerbivoresResultLevel1VC {
