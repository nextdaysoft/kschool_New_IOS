...
class CarnivoresLevel1VC: BaseViewController ,AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "CarnivoresResultLevel1VC"
        ) as? CarnivoresResultLevel1VC {
