...
class CarnivoresLevel3VC: BaseViewController ,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Asiatic Golden Cat",
            imageName: "asiatic_golden_cat_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Andean Mountain Cat",
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // already visited items preserve
        let viewedItems =
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "CarnivoresResultLevel3VC"
        ) as? CarnivoresResultLevel3VC {
