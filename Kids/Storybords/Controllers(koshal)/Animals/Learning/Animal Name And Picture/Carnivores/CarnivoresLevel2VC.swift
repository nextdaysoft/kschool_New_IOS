...
class CarnivoresLevel2VC: BaseViewController ,AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "CarnivoresResultLevel2VC"
        ) as? CarnivoresResultLevel2VC {
