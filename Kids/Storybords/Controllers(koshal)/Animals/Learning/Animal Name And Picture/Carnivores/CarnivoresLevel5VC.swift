...
class CarnivoresLevel5VC: BaseViewController ,AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "CarnivoresResultLevel5VC"
        ) as? CarnivoresResultLevel5VC {
