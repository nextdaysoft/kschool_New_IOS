...
class AquaticLevel2VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Humpback Whale",
            imageName: "humpback_whale"
        ),
        
        LearnPlanetsItem(
            text: "Cardinalfish",
            imageName: "cardinalfish"
        ),
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // ✅ Already visited animals preserve
        let viewedItems = Array(
            planets.prefix(currentIndex + 1)
        )

        // ✅ Remaining animals reshuffle
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "AquaticResultLevel2VC"
        ) as? AquaticResultLevel2VC {
