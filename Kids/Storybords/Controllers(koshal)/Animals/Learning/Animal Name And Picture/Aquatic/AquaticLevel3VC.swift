...
class AquaticLevel3VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // ✅ Already viewed animals preserve
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "AquaticResultLevel3VC"
        ) as? AquaticResultLevel3VC {
