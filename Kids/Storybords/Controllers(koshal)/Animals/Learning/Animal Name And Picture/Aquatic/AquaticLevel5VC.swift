...
class AquaticLevel5VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Goblin Shark",
            imageName: "goblin_shark"
        ),
        
        LearnPlanetsItem(
            text: "Sperm Whale",
            imageName: "sperm_whale"
        ),
        ...
        LearnPlanetsItem(
            text: "Beaked Whale",
            imageName: "beaked_whale"
        ),
        
        LearnPlanetsItem(
            text: "Whale Shark",
            imageName: "whale_shark"
        ),
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // ✅ Already viewed cards preserve
        let viewedItems = Array(
            planets.prefix(currentIndex + 1)
        )

        // ✅ Remaining cards reshuffle
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "AquaticResultLevel5VC"
        ) as? AquaticResultLevel5VC {
