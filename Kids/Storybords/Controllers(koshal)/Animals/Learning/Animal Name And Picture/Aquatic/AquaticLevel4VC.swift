...
class AquaticLevel4VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            ...
            imageName: "hammerhead_shark"
        ),
        
        LearnPlanetsItem(
            text: "Sea Cucumber",
            imageName: "sea_cucumber"
        ),
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // ✅ Jo items already dekh liye preserve karo
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "AquaticResultLevel4VC"
        ) as? AquaticResultLevel4VC {
