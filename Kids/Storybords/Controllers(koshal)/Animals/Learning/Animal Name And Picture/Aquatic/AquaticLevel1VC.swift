...
class AquaticLevel1VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Angel Fish",
            imageName: "angel_fish"
        ),
        
        LearnPlanetsItem(
            text: "Betta Fish",
            imageName: "betta_fish"
        ),
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // ✅ Jo cards dekh chuke ho preserve rakho
        let viewedItems = Array(
            planets.prefix(currentIndex + 1)
        )

        // ✅ Sirf remaining reshuffle honge
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "AquaticResultLevel1VC"
        ) as? AquaticResultLevel1VC {
