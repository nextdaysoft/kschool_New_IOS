...
class AquaticResultLevel4VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "aquaticLevel4Completed")
            if let menuVC = navigationController?.viewControllers.first(
                where: { $0 is AquaticLevelMenuVC }
