...
class SemiAquaticLevel2VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Snapping Turtle",
            imageName: "snapping_turtle"
        ),
        
        LearnPlanetsItem(
            text: "Fishing Eagle",
            imageName: "fishing_eagle"
        ),
        
        LearnPlanetsItem(
            text: "Mudskipper",
            imageName: "mudskipper"
        ),
        
        LearnPlanetsItem(
            text: "Marine Iguana",
            imageName: "marine_iguana"
        ),
        
        LearnPlanetsItem(
            text: "Water Python",
            imageName: "water_python"
        ),
        ...
        LearnPlanetsItem(
            text: "Softshell Turtle",
            imageName: "softshell_turtle"
        ),
        
        LearnPlanetsItem(
            text: "Painted Turtle",
            imageName: "painted_turtle"
        )
    ]
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "SemiAquaticResultLevel2VC"
        ) as? SemiAquaticResultLevel2VC {
