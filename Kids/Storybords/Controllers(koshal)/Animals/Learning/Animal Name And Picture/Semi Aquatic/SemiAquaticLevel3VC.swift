...
class SemiAquaticLevel3VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Hermit Crab",
            imageName: "hermit_crab"
        ),
        
        LearnPlanetsItem(
            text: "Hippopotamus",
            imageName: "hippo_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Polar Bear",
            imageName: "polar_bear_and_baby"
        ),
        ...
        LearnPlanetsItem(
            text: "Water Monitor",
            imageName: "water_monitor"
        ),
        
        LearnPlanetsItem(
            text: "Raccoon",
            imageName: "raccoon_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Bush Dog",
            imageName: "bush_dog_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Horseshoe Crab",
            imageName: "horseshoe_crab"
        ),
        
        LearnPlanetsItem(
            text: "Fishing Cat",
            imageName: "fishing_cat"
        ),
        
        LearnPlanetsItem(
            text: "Water Skink",
            imageName: "water_skink"
        )
    ]
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "SemiAquaticResultLevel3VC"
        ) as? SemiAquaticResultLevel3VC {
