...
class SemiAquaticLevel1VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Water Vole",
            imageName: "water_vole"
        ),
        
        LearnPlanetsItem(
            text: "Water Buffalo",
            imageName: "water_buffalo"
        ),
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "SemiAquaticResultLevel1VC"
        ) as? SemiAquaticResultLevel1VC {
