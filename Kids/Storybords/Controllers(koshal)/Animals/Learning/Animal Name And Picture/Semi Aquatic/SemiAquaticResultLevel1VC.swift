//
//  SemiAquaticResultLevel1VC.swift
//  Kids
//
...
class SemiAquaticResultLevel1VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "semiAquaticLevel1Completed")
            if let menuVC = navigationController?.viewControllers.first(
                where: { $0 is SemiAquaticLevelMenuVC }
