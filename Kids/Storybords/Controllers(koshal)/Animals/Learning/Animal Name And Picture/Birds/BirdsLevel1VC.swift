...
class BirdsLevel1VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Peacock".localiz(),
            imageName: "peacock_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Ostrich".localiz(),
    ...
    func showSwipeUpHint() {
        ...
        let label = UILabel()
        label.text = "Swipe up to change animal".localiz()
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "BirdsResultLevel1VC"
        ) as? BirdsResultLevel1VC {
