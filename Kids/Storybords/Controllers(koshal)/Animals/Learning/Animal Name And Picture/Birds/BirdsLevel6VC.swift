...
class BirdsLevel6VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Nightingale".localiz(),
            imageName: "nightingale_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Kestrel".localiz(),
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "BirdsResultLevel6VC"
        ) as? BirdsResultLevel6VC {
