...
class BirdsLevel3VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // ✅ Jo birds already dekh liye unko preserve rakho
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "BirdsResultLevel3VC"
        ) as? BirdsResultLevel3VC {
