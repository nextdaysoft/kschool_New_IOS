...
class BirdsLevelMenuVC: BaseViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if UserDefaults.standard.bool(forKey: "birdsLevel1Completed") {
            image1.image = UIImage(named: "done")
        } else {
            image1.image = nil
        }
        
        if UserDefaults.standard.bool(forKey: "birdsLevel2Completed") {
            image2.image = UIImage(named: "done")
        } else {
            image2.image = nil
        }
        
        if UserDefaults.standard.bool(forKey: "birdsLevel3Completed") {
            image3.image = UIImage(named: "done")
        } else {
            image3.image = nil
        }
        
        if UserDefaults.standard.bool(forKey: "birdsLevel4Completed") {
            image4.image = UIImage(named: "done")
        } else {
            image4.image = nil
        }
        
        if UserDefaults.standard.bool(forKey: "birdsLevel5Completed") {
            image5.image = UIImage(named: "done")
        } else {
            image5.image = nil
        }
        
        if UserDefaults.standard.bool(forKey: "birdsLevel6Completed") {
    ...
    func updateResetVisibility() {
        ...
        let isAnyCompleted =
            UserDefaults.standard.bool(forKey: "birdsLevel1Completed") ||
            UserDefaults.standard.bool(forKey: "birdsLevel2Completed") ||
            UserDefaults.standard.bool(forKey: "birdsLevel3Completed") ||
            UserDefaults.standard.bool(forKey: "birdsLevel4Completed") ||
            UserDefaults.standard.bool(forKey: "birdsLevel5Completed") ||
            UserDefaults.standard.bool(forKey: "birdsLevel6Completed")
    ...
    func setupSubscriptionLock() {
        ...
        for (level,image,bg) in levels {
            ...
            UserDefaults.standard.bool(
                forKey: "birdsLevel\(level)Completed"
            )
    ...
    @IBAction func restTapBtn(_ sender: UIButton) {
        ...
        for i in 1...6 {
            defaults.set(false, forKey: "birdsLevel\(i)Completed")
        }
