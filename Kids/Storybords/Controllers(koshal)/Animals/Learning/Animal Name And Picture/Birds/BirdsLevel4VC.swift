...
class BirdsLevel4VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Pelican".localiz(),
            imageName: "pelican_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Ptarmigan".localiz(),
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // ✅ Already visited birds preserve
        let viewedItems = Array(
            planets.prefix(currentIndex + 1)
        )

        // ✅ Remaining birds reshuffle
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "BirdsResultLevel4VC"
        ) as? BirdsResultLevel4VC {
