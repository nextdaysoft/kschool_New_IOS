...
class BirdsLevel5VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Cormorant".localiz(),
            imageName: "cormorant_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Spoonbill".localiz(),
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "BirdsResultLevel5VC"
        ) as? BirdsResultLevel5VC {
