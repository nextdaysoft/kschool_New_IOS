//
//  AnimalNameAndPictureLevelsMenuVC.swift
//  Kids
//
...
class AnimalNameAndPictureLevelsMenuVC: BaseViewController {
    ...
    @IBAction func level1TapBtn(_ sender: UIButton) {
        ...
        let vc = storyboard.instantiateViewController(
            withIdentifier: "BirdsLevelMenuVC"
        ) as! BirdsLevelMenuVC
    ...
    @IBAction func level2TapBtn(_ sender: UIButton) {
        ...
        if let vc = storyboard.instantiateViewController(
            withIdentifier: "HerbivoresLevelMenuVC"
        ) as? HerbivoresLevelMenuVC {
    ...
    @IBAction func level3TapBtn(_ sender: UIButton) {
        ...
        if let vc = storyboard.instantiateViewController(
            withIdentifier: "CarnivoresLevelMenuVC"
        ) as? CarnivoresLevelMenuVC {
    ...
    @IBAction func level4TapBtn(_ sender: UIButton) {
        ...
        if let vc = storyboard.instantiateViewController(
            withIdentifier: "OmnivoresLevelMenuVC"
        ) as? OmnivoresLevelMenuVC {
    ...
    @IBAction func level5TapBtn(_ sender: UIButton) {
        ...
        if let vc = storyboard.instantiateViewController(
            withIdentifier: "AquaticLevelMenuVC"
        ) as? AquaticLevelMenuVC {
    ...
    @IBAction func level6TapBtn(_ sender: UIButton) {
        ...
        if let vc = storyboard.instantiateViewController(
            withIdentifier: "SemiAquaticLevelMenuVC"
        ) as? SemiAquaticLevelMenuVC {
