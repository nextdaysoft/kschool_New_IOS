...
class OmnivoresResultLevel1VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "omnivoresLevel1Completed")
            if let menuVC = navigationController?.viewControllers.first(
                where: { $0 is OmnivoresLevelMenuVC }
