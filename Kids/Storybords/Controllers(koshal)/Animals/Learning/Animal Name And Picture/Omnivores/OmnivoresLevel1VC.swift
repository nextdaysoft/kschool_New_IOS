...
class OmnivoresLevel1VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "OmnivoresResultLevel1VC"
        ) as? OmnivoresResultLevel1VC {
