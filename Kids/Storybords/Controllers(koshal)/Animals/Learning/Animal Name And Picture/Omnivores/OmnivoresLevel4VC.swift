...
class OmnivoresLevel4VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "OmnivoresResultLevel4VC"
        ) as? OmnivoresResultLevel4VC {
