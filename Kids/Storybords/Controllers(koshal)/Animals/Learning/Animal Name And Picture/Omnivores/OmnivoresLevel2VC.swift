...
class OmnivoresLevel2VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "OmnivoresResultLevel2VC"
        ) as? OmnivoresResultLevel2VC {
