...
class OmnivoresLevel3VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "OmnivoresResultLevel3VC"
        ) as? OmnivoresResultLevel3VC {
