//
//  OmnivoresBabyNamesLevel1VC.swift
//  Kids
//
...
class OmnivoresBabyNamesLevel1VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "OmnivoresBabyNamesResultLevel1VC"
        ) as? OmnivoresBabyNamesResultLevel1VC {
