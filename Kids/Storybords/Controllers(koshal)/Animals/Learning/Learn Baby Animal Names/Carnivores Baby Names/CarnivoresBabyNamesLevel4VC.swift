//
//  CarnivoresBabyNamesLevel4VC.swift
//  Kids
//
...
class CarnivoresBabyNamesLevel4VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Ethiopian Wolf’s baby is called a pup",
            imageName: "ethiopian_wolf_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Kodkod’s baby is called a kitten",
            imageName: "kodkod_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Sand Cat’s baby is called a kitten",
            imageName: "sand_cat_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Indian Desert Fox’s baby is called a pup",
            imageName: "indian_desert_fox_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Margay’s baby is called a kitten",
            imageName: "margay_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Fisher’s baby is called a kit",
            imageName: "fisher_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Black-footed Cat’s baby is called a kitten",
            imageName: "black_footed_cat_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Steppe Polecat’s baby is called a kit",
            imageName: "steppe_polecat_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Pallas's Cat’s baby is called a kitten",
            imageName: "pallas_cat_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Himalayan Red Fox’s baby is called a pup",
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "CarnivoresBabyNamesResultLevel4VC"
        ) as? CarnivoresBabyNamesResultLevel4VC {
