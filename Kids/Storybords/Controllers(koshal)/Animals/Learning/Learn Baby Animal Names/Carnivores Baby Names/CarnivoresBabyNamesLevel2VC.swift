//
//  CarnivoresBabyNamesLevel2VC.swift
//  Kids
//
...
class CarnivoresBabyNamesLevel2VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Marbled Cat’s baby is called a kitten",
            imageName: "marbled_cat"
        ),
        
        LearnPlanetsItem(
            text: "African Golden Cat’s baby is called a kitten",
            imageName: "african_golden_cat"
        ),
        
        LearnPlanetsItem(
            text: "Coyote’s baby is called a pup",
            imageName: "coyote_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Gray Wolf’s baby is called a pup",
            imageName: "gray_wolf_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "American Mink’s baby is called a kit",
            imageName: "american_mink_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "African Wild Dog’s baby is called a pup",
            imageName: "african_wild_dog"
        ),
        
        LearnPlanetsItem(
            text: "Wolverine’s baby is called a kit",
            imageName: "wolverine_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Lynx’s baby is called a kitten",
        ...
        LearnPlanetsItem(
            text: "Dingo’s baby is called a pup",
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "CarnivoresBabyNamesResultLevel2VC"
        ) as? CarnivoresBabyNamesResultLevel2VC {
