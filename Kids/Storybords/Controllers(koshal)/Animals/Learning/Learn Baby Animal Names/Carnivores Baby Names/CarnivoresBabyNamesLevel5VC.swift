//
//  CarnivoresBabyNamesLevel5VC.swift
//  Kids
//
...
class CarnivoresBabyNamesLevel5VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Caracal’s baby is called a kitten",
            imageName: "caracal_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Striped Polecat’s baby is called a kit",
            imageName: "striped_pole_cat_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Serval’s baby is called a kitten",
            imageName: "serval_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Canadian Lynx’s baby is called a kitten",
            imageName: "canadian_lynx_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Tibetan Wolf’s baby is called a pup",
            imageName: "tibetan_wolf_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Bay Cat’s baby is called a kitten",
            imageName: "bay_cat_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Zorilla’s baby is called a kit",
            imageName: "zorilla_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Brown Hyena’s baby is called a cub",
            imageName: "brown_hyena_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Clouded Leopard’s baby is called a cub",
            imageName: "clouded_leopard_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Arctic Fox’s baby is called a pup",
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "CarnivoresBabyNamesResultLevel5VC"
        ) as? CarnivoresBabyNamesResultLevel5VC {
