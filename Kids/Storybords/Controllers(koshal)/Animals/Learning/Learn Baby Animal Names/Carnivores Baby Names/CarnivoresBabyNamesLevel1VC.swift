//
//  CarnivoresBabyNamesLevel1VC.swift
//  Kids
//
...
class CarnivoresBabyNamesLevel1VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Jaguar’s baby is called a cub",
            imageName: "jaguar_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Mountain Lion’s baby is called a cub",
            imageName: "mountain_lion_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Cheetah’s baby is called a cub",
            imageName: "cheetah_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Wolf’s baby is called a pup",
            imageName: "wolf_and_pup"
        ),
        
        LearnPlanetsItem(
            text: "Panther’s baby is called a cub",
            imageName: "panther_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Lion’s baby is called a cub",
            imageName: "lion_and_cub"
        ),
        
        LearnPlanetsItem(
            text: "Eurasian Lynx’s baby is called a kitten",
            imageName: "eurasian_lynx_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Tiger’s baby is called a cub",
            imageName: "tiger_and_cub"
        ),
        
        LearnPlanetsItem(
            text: "Leopard’s baby is called a cub",
            imageName: "leopard_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Snow Leopard’s baby is called a cub",
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "CarnivoresBabyNamesResultLevel1VC"
        ) as? CarnivoresBabyNamesResultLevel1VC {
