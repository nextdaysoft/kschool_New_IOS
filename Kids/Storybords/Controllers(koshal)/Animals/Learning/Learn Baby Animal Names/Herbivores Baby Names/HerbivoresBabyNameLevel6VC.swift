//
//  HerbivoresBabyNameLevel6VC.swift
//  Kids
//
...
class HerbivoresBabyNameLevel6VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Reedbuck’s baby is called a fawn",
            imageName: "reedbuck_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Argali’s baby is called a lamb",
            imageName: "argali_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Mountain Goat’s baby is called a kid",
            imageName: "mountain_goat_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Springbok’s baby is called a lamb",
            imageName: "springbok_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Waterbuck’s baby is called a calf",
            imageName: "waterbuck_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Gaur’s baby is called a calf",
            imageName: "gaur_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Takin’s baby is called a calf",
            imageName: "takin_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Hartebeest’s baby is called a calf",
            imageName: "hartebeest_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Banteng’s baby is called a calf",
            imageName: "banteng_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Roan Antelope’s baby is called a calf",
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "HerbivoresBabyNameResultLevel6VC"
        ) as? HerbivoresBabyNameResultLevel6VC {
