//
//  HerbivoresBabyNameLevel4VC.swift
//  Kids
//
...
class HerbivoresBabyNameLevel4VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Vicuña’s baby is called a cria",
            imageName: "vicuna_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Nyala’s baby is called a calf",
            imageName: "nyala_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Addax’s baby is called a calf",
            imageName: "addax_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Pronghorn’s baby is called a fawn",
            imageName: "pronghorn_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Alpaca’s baby is called a cria",
            imageName: "alpaca_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Oryx’s baby is called a calf",
            imageName: "oryx_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Saiga’s baby is called a calf",
            imageName: "saiga_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Eland’s baby is called a calf",
            imageName: "eland_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Bongo’s baby is called a calf",
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "HerbivoresBabyNameResultLevel4VC"
        ) as? HerbivoresBabyNameResultLevel4VC {
