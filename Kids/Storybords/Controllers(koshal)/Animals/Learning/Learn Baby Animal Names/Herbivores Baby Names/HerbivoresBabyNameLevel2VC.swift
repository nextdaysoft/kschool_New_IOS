//
//  HerbivoresBabyNameLevel2VC.swift
//  Kids
//
...
class HerbivoresBabyNameLevel2VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Koala’s baby is called a joey",
            imageName: "koala_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Buffalo’s baby is called a calf",
            imageName: "buffalo_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Bharal’s baby is called a lamb",
            imageName: "bharal_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Panda’s baby is called a cub",
            imageName: "panda_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Bison’s baby is called a calf",
            imageName: "bison_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Yak’s baby is called a calf",
            imageName: "yak_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Camel’s baby is called a calf",
            imageName: "camel_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Rabbit’s baby is called a kit",
            imageName: "rabbit_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Llama’s baby is called a cria",
            imageName: "llama_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Zebra’s baby is called a foal",
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "HerbivoresBabyNameResultLevel2VC"
        ) as? HerbivoresBabyNameResultLevel2VC {
