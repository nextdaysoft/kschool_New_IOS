//
//  HerbivoresBabyNameLevel1VC.swift
//  Kids
//
...
class HerbivoresBabyNameLevel1VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Elephant’s baby is called a calf",
            imageName: "elephant_and_calf"
        ),
        
        LearnPlanetsItem(
            text: "Goat’s baby is called a kid",
            imageName: "goat_and_kid"
        ),
        
        LearnPlanetsItem(
            text: "Cow’s baby is called a calf",
            imageName: "cow_and_calf"
        ),
        
        LearnPlanetsItem(
            text: "Kangaroo’s baby is called a joey",
            imageName: "kangaroo_and_joey"
        ),
        
        LearnPlanetsItem(
            text: "Giraffe’s baby is called a calf",
            imageName: "giraffe_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Deer’s baby is called a fawn",
            imageName: "deer_and_fawn"
        ),
        
        LearnPlanetsItem(
            text: "Rhinoceros’s baby is called a calf",
            imageName: "rhino_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Donkey’s baby is called a foal",
            imageName: "donkey_and_foal"
        ),
        
        LearnPlanetsItem(
            text: "Sheep’s baby is called a lamb",
            imageName: "sheep_and_lamb"
        ),
        
        LearnPlanetsItem(
            text: "Horse’s baby is called a foal",
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "HerbivoresBabyNameResultLevel1VC"
        ) as? HerbivoresBabyNameResultLevel1VC {
