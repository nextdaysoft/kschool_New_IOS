//
//  HerbivoresBabyNameLevel3VC.swift
//  Kids
//
...
class HerbivoresBabyNameLevel3VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Wildebeest’s baby is called a calf",
            imageName: "wildebeest_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Okapi’s baby is called a calf",
            imageName: "okapi_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Tapir’s baby is called a calf",
            imageName: "tapir_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Mule’s baby is called a foal",
            imageName: "mule_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Antelope’s baby is called a calf",
            imageName: "antelope_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Moose’s baby is called a calf",
            imageName: "moose_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Ibex’s baby is called a kid",
            imageName: "ibex_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Chamois’s baby is called a kid",
            imageName: "chamois_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Reindeer’s baby is called a calf",
            imageName: "reindeer_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Gazelle’s baby is called a fawn",
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "HerbivoresBabyNameResultLevel3VC"
        ) as? HerbivoresBabyNameResultLevel3VC {
