//
//  HerbivoresBabyNameLevel5VC.swift
//  Kids
//
...
class HerbivoresBabyNameLevel5VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Tahr’s baby is called a kid",
            imageName: "tahr_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Blackbuck’s baby is called a fawn",
            imageName: "blackbuck_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Serow’s baby is called a kid",
            imageName: "serow_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Nilgai’s baby is called a calf",
            imageName: "nilgai_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Markhor’s baby is called a kid",
            imageName: "markhor_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Barasingha’s baby is called a fawn",
            imageName: "barasingha_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Goral’s baby is called a kid",
            imageName: "goral_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Muntjac’s baby is called a fawn",
            imageName: "muntjac_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Sambar’s baby is called a fawn",
            imageName: "sambar_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Kouprey’s baby is called a calf",
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "HerbivoresBabyNameResultLevel5VC"
        ) as? HerbivoresBabyNameResultLevel5VC {
