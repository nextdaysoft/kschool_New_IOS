...
class BirdsDetailsLevel2VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Eagle’s baby is called an eaglet",
            imageName: "eagle_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Crow’s baby is called a chick",
            imageName: "crow_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Hawk’s baby is called an eyas",
            imageName: "hawk_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Penguin’s baby is called a chick",
            imageName: "penguin_baby"
        ),
        
        LearnPlanetsItem(
            text: "Goose’s baby is called a gosling",
            imageName: "goose_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Seagull’s baby is called a chick",
            imageName: "seagull_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Emu’s baby is called a chick",
            imageName: "emu_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Dove’s baby is called a chick",
            imageName: "dove_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Flamingo’s baby is called a chick",
            imageName: "flamingo_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Falcon’s baby is called an eyas",
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "BirdsDetailsResultLevel2VC"
        ) as? BirdsDetailsResultLevel2VC {
