...
class BirdsDetailsLevel1VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Peacock's baby is called a peachick",
            imageName: "peacock_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Ostrich's baby is called a chick",
            imageName: "ostrich_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Turkey's baby is called a poult",
            imageName: "turkey_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Owl's baby is called an owlet",
            imageName: "owl_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Swan's baby is called a cygnet",
            imageName: "swan_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Parrot's baby is called a chick",
            imageName: "parrot_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Sparrow's baby is called a chick",
            imageName: "sparrow_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Pigeon's baby is called a chick",
            imageName: "pigeon_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Hen's baby is called a chick",
            imageName: "hen_and_chick"
        ),
        
        LearnPlanetsItem(
            text: "Duck's baby is called a duckling",
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // already visited preserve
        let viewedItems =
            Array(planets.prefix(currentIndex + 1))

        // remaining only reshuffle
        var remainingItems =
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "BirdsDetailsResultLevel1VC"
        ) as? BirdsDetailsResultLevel1VC {
