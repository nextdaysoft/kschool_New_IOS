...
class BirdsDetailsLevel6VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Kestrel's baby is called an eyas",
            imageName: "kestrel_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Treepie's baby is called a chick",
            imageName: "treepie_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Osprey's baby is called an eyas",
            imageName: "osprey_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Macaw's baby is called a chick",
            imageName: "macaw_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Toucan's baby is called a chick",
            imageName: "toucan_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Oriole's baby is called a chick",
            imageName: "oriole_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Babbler's baby is called a chick",
            imageName: "babbler_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Shrike's baby is called a chick",
            imageName: "shrike_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Lyrebird's baby is called a chick",
            imageName: "lyrebird_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Nightingale's baby is called a chick",
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // keep already viewed items
        let viewedItems =
            Array(planets.prefix(currentIndex + 1))

        // reshuffle remaining only
        var remainingItems =
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "BirdsDetailsResultLevel6VC"
        ) as? BirdsDetailsResultLevel6VC {
