...
class BirdsDetailsLevel5VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Lark’s baby is called a chick",
            imageName: "lark_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Wagtail’s baby is called a chick",
            imageName: "wagtail_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Ibis’s baby is called a chick",
            imageName: "ibis_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Cormorant’s baby is called a chick",
            imageName: "cormorant_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Spoonbill’s baby is called a chick",
            imageName: "spoonbill_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Condor’s baby is called a chick",
            imageName: "condor_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Sunbird’s baby is called a chick",
            imageName: "sunbird_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Swift’s baby is called a chick",
            imageName: "swift_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Bulbul’s baby is called a chick",
            imageName: "bulbul_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Finch’s baby is called a chick",
    ...
    func goToResultScreen() {
        ...
        print("goToResultScreen Called")

        let storyboard = UIStoryboard(name: "KoshalSB", bundle: nil)

        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "BirdsDetailsResultLevel5VC"
        ) as? BirdsDetailsResultLevel5VC {

            print("Result VC Created")

            navigationController?.pushViewController(resultVC, animated: false)

        } else {
            print("Storyboard ID Wrong")
        }
    }
