...
class BirdsDetailsLevel4VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Starling’s baby is called a chick",
            imageName: "starling_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Buzzard’s baby is called an eyas",
            imageName: "buzzard_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Crow Pheasant’s baby is called a chick",
            imageName: "crow_pheasant_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Kingfisher’s baby is called a chick",
            imageName: "kingfisher_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Hornbill’s baby is called a chick",
            imageName: "hornbill_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Quail’s baby is called a chick",
            imageName: "quail_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Pelican’s baby is called a chick",
            imageName: "pelican_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Ptarmigan’s baby is called a chick",
            imageName: "ptarmigan_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Stork’s baby is called a chick",
            imageName: "stork_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Woodpecker’s baby is called a chick",
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // visited items preserve
        let viewedItems =
            Array(planets.prefix(currentIndex + 1))

        // remaining items reshuffle
        var remainingItems =
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "BirdsDetailsResultLevel4VC"
        ) as? BirdsDetailsResultLevel4VC {
