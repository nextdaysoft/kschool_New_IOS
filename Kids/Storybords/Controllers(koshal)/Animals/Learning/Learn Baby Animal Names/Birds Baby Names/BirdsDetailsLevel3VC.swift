...
class BirdsDetailsLevel3VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Crane’s baby is called a chick",
            imageName: "crane_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Myna’s baby is called a chick",
            imageName: "myna_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Heron’s baby is called a chick",
            imageName: "heron_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Vulture’s baby is called a chick",
            imageName: "vulture_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Cuckoo’s baby is called a chick",
            imageName: "cuckoo_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Albatross’s baby is called a chick",
            imageName: "albatross_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Magpie’s baby is called a chick",
            imageName: "magpie_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Blackbird’s baby is called a chick",
            imageName: "blackbird_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Canary’s baby is called a chick",
            imageName: "canary_and_baby"
        ),
        
        LearnPlanetsItem(
            text: "Robin’s baby is called a chick",
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "BirdsDetailsResultLevel3VC"
        ) as? BirdsDetailsResultLevel3VC {
