//
//  BirdsDetailsResultLevel2VC.swift
//  Kids
//
...
class BirdsDetailsResultLevel2VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "birdsDetailsLevel2Completed")
            if let menuVC = navigationController?.viewControllers.first(
                where: { $0 is BirdsDetailsMenuVC }
            ) as? BirdsDetailsMenuVC {
