//
//  LearnOmnivoresAnimalGroupNameShowVC.swift
//  Kids
//
...
class LearnOmnivoresAnimalGroupNameShowVC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnOmnivoresAnimalGroupNameResultVC"
        ) as? LearnOmnivoresAnimalGroupNameResultVC {
