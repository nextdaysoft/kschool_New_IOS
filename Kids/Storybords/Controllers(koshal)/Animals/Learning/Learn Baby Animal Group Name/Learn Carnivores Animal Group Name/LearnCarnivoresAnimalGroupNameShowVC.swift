//
//  LearnCarnivoresAnimalGroupNameShowVC.swift
//  Kids
//
...
class LearnCarnivoresAnimalGroupNameShowVC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnCarnivoresAnimalGroupNameResultVC"
        ) as? LearnCarnivoresAnimalGroupNameResultVC {
