//
//  LearnBirdsAnimalGroupNameShowVC.swift
//  Kids
//
...
class LearnBirdsAnimalGroupNameShowVC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnBirdsAnimalGroupNameResultVC"
        ) as? LearnBirdsAnimalGroupNameResultVC {
