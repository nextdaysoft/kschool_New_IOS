//
//  ListenAnimalSoundResultLevel4VC.swift
//  Kids
//
...
class ListenAnimalSoundResultLevel4VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "listenAnimalSound1Level4Completed")
            if let menuVC = navigationController?.viewControllers.first(
                where: { $0 is ListenAnimalSoundMenuVC }
