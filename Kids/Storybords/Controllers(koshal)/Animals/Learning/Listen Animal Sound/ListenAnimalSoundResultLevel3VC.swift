//
//  ListenAnimalSoundResultLevel3VC.swift
//  Kids
//
...
class ListenAnimalSoundResultLevel3VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "listenAnimalSound1Level3Completed")
