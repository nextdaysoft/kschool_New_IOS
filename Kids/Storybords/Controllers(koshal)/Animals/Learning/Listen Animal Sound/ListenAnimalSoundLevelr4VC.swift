//
//  ListenAnimalSoundLevelr4VC.swift
//  Kids
//
...
class ListenAnimalSoundLevel4VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(text: "Camel", imageName: "camel_and_baby"),
        LearnPlanetsItem(text: "Chimpanzee", imageName: "chimpanzee_and_baby"),
        LearnPlanetsItem(text: "Frog", imageName: "ic_frog"),
        LearnPlanetsItem(text: "Hippo", imageName: "hippo_and_baby"),
        LearnPlanetsItem(text: "Kangaroo", imageName: "kangaroo_and_joey"),
        LearnPlanetsItem(text: "Rabbit", imageName: "rabbit_and_baby"),
        LearnPlanetsItem(text: "Rhino", imageName: "rhino_and_baby"),
        LearnPlanetsItem(text: "Snake", imageName: "ic_snake"),
        LearnPlanetsItem(text: "Vulture", imageName: "vulture_and_baby"),
        LearnPlanetsItem(text: "Wolf", imageName: "wolf_and_pup")
    ]
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "ListenAnimalSoundResultLevel4VC"
        ) as? ListenAnimalSoundResultLevel4VC {
