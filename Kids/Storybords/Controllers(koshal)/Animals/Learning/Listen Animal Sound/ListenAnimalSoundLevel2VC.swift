//
//  ListenAnimalSoundLevel2VC.swift
//  Kids
//
...
class ListenAnimalSoundLevel2VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(text: "Cat", imageName: "pampas_cat"),
        LearnPlanetsItem(text: "Cow", imageName: "cow_and_calf"),
        LearnPlanetsItem(text: "Dog", imageName: "dog_and_puppy"),
        LearnPlanetsItem(text: "Donkey", imageName: "donkey_and_foal"),
        LearnPlanetsItem(text: "Duck", imageName: "duck_and_duckling"),
        LearnPlanetsItem(text: "Goat", imageName: "goat_and_kid"),
        LearnPlanetsItem(text: "Hen", imageName: "hen_and_chick"),
        LearnPlanetsItem(text: "Horse", imageName: "horse_and_foal"),
        LearnPlanetsItem(text: "Pig", imageName: "pig_and_piglet"),
        LearnPlanetsItem(text: "Sheep", imageName: "sheep_and_lamb")
    ]
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "ListenAnimalSoundResultLevel2VC"
        ) as? ListenAnimalSoundResultLevel2VC {
