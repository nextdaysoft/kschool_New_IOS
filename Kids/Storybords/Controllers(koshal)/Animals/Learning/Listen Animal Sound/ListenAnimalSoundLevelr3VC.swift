//
//  ListenAnimalSoundLevelr3VC.swift
//  Kids
//
...
class ListenAnimalSoundLevel3VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(text: "Bear", imageName: "brown_bear_and_baby"),
        LearnPlanetsItem(text: "Deer", imageName: "deer_and_fawn"),
        LearnPlanetsItem(text: "Elephant", imageName: "elephant_and_calf"),
        LearnPlanetsItem(text: "Fox", imageName: "red_fox_and_baby"),
        LearnPlanetsItem(text: "Giraffe", imageName: "giraffe_and_baby"),
        LearnPlanetsItem(text: "Lion", imageName: "lion_and_cub"),
        LearnPlanetsItem(text: "Monkey", imageName: "monkey_and_baby"),
        LearnPlanetsItem(text: "Panda", imageName: "panda_and_baby"),
        LearnPlanetsItem(text: "Tiger", imageName: "tiger_and_cub"),
        LearnPlanetsItem(text: "Zebra", imageName: "zebra_and_baby"),
    ]
    ...
    func playAnimalSound() {
        ...
        let currentAnimal = planets[currentIndex].text.lowercased()
        
        // Special case: parrots (sound file plural hai)
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "ListenAnimalSoundResultLevel3VC"
        ) as? ListenAnimalSoundResultLevel3VC {
    ...
    func createFruitsPDF() -> URL? {
        ...
        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("Animals.pdf")
