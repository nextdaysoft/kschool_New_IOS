//
//  ListenAnimalSoundLevel1VC.swift
//  Kids
//
...
class ListenAnimalSoundLevel1VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    var planets: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(text: "Turkey", imageName: "turkey_and_baby"),
        LearnPlanetsItem(text: "Rooster", imageName: "rooster"),
        LearnPlanetsItem(text: "Eagle", imageName: "eagle_and_baby"),
        LearnPlanetsItem(text: "Parrot", imageName: "parrot_and_baby"),
        LearnPlanetsItem(text: "Peacock", imageName: "peacock_and_baby"),
        LearnPlanetsItem(text: "Owl", imageName: "owl_and_baby"),
        LearnPlanetsItem(text: "Sparrow", imageName: "sparrow_and_baby"),
        LearnPlanetsItem(text: "Goose", imageName: "goose_and_baby"),
        LearnPlanetsItem(text: "Crow", imageName: "crow_and_baby"),
        LearnPlanetsItem(text: "Pigeon", imageName: "pigeon_and_baby")
    ]
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "ListenAnimalSoundResultLevel1VC"
        ) as? ListenAnimalSoundResultLevel1VC {
