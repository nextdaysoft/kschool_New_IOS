//
//  ListenAnimalSoundResultLevel2VC.swift
//  Kids
//
...
class ListenAnimalSoundResultLevel2VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "listenAnimalSound1Level2Completed")
