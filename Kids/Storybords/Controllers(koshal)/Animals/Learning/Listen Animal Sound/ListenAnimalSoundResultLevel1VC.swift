//
//  ListenAnimalSoundResultLevel1VC.swift
//  Kids
//
...
class ListenAnimalSoundResultLevel1VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "listenAnimalSound1Level1Completed")
