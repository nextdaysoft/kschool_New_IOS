...
class LearnAnimalsFactShowVC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnAnimalsFactResultVC"
        ) as? LearnAnimalsFactResultVC {
