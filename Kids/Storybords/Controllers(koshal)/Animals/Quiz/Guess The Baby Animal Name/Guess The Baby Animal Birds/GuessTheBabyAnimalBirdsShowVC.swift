//
//  GuessTheBabyAnimalBirdsShowVC.swift
//  Kids
//
//  Created by Koshal Singh on 27/02/26.
//
struct BabyAnimalQuestion {
    let question: String
    let options: [String]
...
class GuessTheBabyAnimalBirdsShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessTheBabyAnimalBirdsResultVC"
        ) as? GuessTheBabyAnimalBirdsResultVC {
