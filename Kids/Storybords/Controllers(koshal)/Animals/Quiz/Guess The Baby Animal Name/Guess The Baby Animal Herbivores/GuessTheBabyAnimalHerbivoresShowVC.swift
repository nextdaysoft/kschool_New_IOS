//
//  GuessTheBabyAnimalHerbivoresShowVC.swift
//  Kids
//
...
class GuessTheBabyAnimalHerbivoresShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessTheBabyAnimalHerbivoresResultVC"
        ) as? GuessTheBabyAnimalHerbivoresResultVC {
