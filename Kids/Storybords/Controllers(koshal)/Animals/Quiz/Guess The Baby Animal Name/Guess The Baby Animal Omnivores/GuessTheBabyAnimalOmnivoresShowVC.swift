//
//  GuessTheBabyAnimalOmnivoresShowVC.swift
//  Kids
//
...
class GuessTheBabyAnimalOmnivoresShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessTheBabyAnimalOmnivoresResultVC"
        ) as? GuessTheBabyAnimalOmnivoresResultVC {
