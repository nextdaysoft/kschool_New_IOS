//
//  GuessTheBabyAnimalCarnivoresShowVC.swift
//  Kids
//
...
class GuessTheBabyAnimalCarnivoresShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessTheBabyAnimalCarnivoresResultVC"
        ) as? GuessTheBabyAnimalCarnivoresResultVC {
