//
//  GuessTheAnimalAquaticShowVC.swift
//  Kids
//
...
class GuessTheAnimalAquaticShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResult() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessTheAnimalAquaticResultVC"
        ) as? GuessTheAnimalAquaticResultVC {
