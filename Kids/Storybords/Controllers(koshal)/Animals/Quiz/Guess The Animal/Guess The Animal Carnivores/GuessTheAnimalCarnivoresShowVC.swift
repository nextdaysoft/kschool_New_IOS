//
//  GuessTheAnimalCarnivoresShowVC.swift
//  Kids
//
...
class GuessTheAnimalCarnivoresShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResult() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessTheAnimalCarnivoresResultVC"
        ) as? GuessTheAnimalCarnivoresResultVC {
