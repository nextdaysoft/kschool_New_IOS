//
//  GuessTheAnimalSemiAquaticShowVC.swift
//  Kids
//
...
class GuessTheAnimalSemiAquaticShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResult() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessTheAnimalSemiAquaticResultVC"
        ) as? GuessTheAnimalSemiAquaticResultVC {
