//
//  GuessTheAnimalHerbivoresShowVC.swift
//  Kids
//
...
class GuessTheAnimalHerbivoresShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResult() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessTheAnimalHerbivoresResultVC"
        ) as? GuessTheAnimalHerbivoresResultVC {
