//
//  GuessTheAnimalBirdsShowVC.swift
//  Kids
//
...
class GuessTheAnimalBirdsShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResult() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessTheAnimalBirdsResultVC"
        ) as? GuessTheAnimalBirdsResultVC {
