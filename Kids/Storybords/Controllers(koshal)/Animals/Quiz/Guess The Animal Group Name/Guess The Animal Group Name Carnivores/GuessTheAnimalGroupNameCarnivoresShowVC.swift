//
//  GuessTheAnimalGroupNameCarnivoresShowVC.swift
//  Kids
//
...
class GuessTheAnimalGroupNameCarnivoresShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessTheAnimalGroupNameCarnivoresResultVC"
        ) as? GuessTheAnimalGroupNameCarnivoresResultVC {
