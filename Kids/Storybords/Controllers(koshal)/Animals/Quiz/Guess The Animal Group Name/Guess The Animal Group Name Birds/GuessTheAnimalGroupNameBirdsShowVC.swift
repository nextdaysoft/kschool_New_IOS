//
//  GuessTheAnimalGroupNameBirdsShowVC.swift
//  Kids
//
...
class GuessTheAnimalGroupNameBirdsShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessTheAnimalGroupNameBirdsResultVC"
        ) as? GuessTheAnimalGroupNameBirdsResultVC {
