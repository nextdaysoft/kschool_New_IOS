//
//  GuessTheAnimalGroupNameHerbivoresShowVC.swift
//  Kids
//
...
class GuessTheAnimalGroupNameHerbivoresShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessTheAnimalGroupNameHerbivoresResultVC"
        ) as? GuessTheAnimalGroupNameHerbivoresResultVC {
