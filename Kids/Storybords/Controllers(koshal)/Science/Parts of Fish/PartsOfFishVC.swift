...
class PartsOfFishVC: BaseViewController {

    @IBOutlet weak var eyeView: UIView!
    @IBOutlet weak var gillsView: UIView!
    @IBOutlet weak var tailView: UIView!
    @IBOutlet weak var mouthView: UIView!
    @IBOutlet weak var finView: UIView!
    ...
    override func viewDidLoad() {
        ...
        correctMapping = [
            eyeView: "Eye".localiz(),
            gillsView: "Gills".localiz(),
            tailView: "Tail".localiz(),
            mouthView: "Mouth".localiz(),
            finView: "Fin".localiz()
        ]
    ...
    @IBAction func nextAndUndoTapBtn(_ sender: UIButton) {
        ...
        if let menuVC = navigationController?.viewControllers.first(
            ...
            UserDefaults.standard.set(true, forKey: "scienceLevel12Completed")
            UserDefaults.standard.set(percentage, forKey: "scienceLevel12Percentage")
