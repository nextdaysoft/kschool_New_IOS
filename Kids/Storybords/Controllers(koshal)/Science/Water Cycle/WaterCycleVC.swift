...
class WaterCycleVC: BaseViewController {

    @IBOutlet weak var condensationView: UIView!
    @IBOutlet weak var evaporationView: UIView!
    ...
    override func viewDidLoad() {
        ...
        setupView(condensationView)
        setupView(evaporationView)
        setupView(collectionView)
        setupView(precipitationView)
        ...
        correctMapping = [
            condensationView: "Condensation".localiz(),
            evaporationView: "Evaporation".localiz(),
            collectionView: "Collection".localiz(),
            precipitationView: "Precipitation".localiz(),
        ]
    ...
    func setupRandomLabels() {
        ...
        let parts = [
            "Condensation".localiz(),
            "Evaporation".localiz(),
            "Collection".localiz(),
            "Precipitation".localiz()
        ]
    ...
    func checkDrop(_ draggedView: UIView) {
        ...
        let targets: [UIView: UIView] = [
            view1: condensationView,
            view2: evaporationView,
            view3: collectionView,
            view4: precipitationView
        ]
    ...
    @IBAction func nextAndUndoTapBtn(_ sender: UIButton) {
        ...
        if let menuVC = navigationController?.viewControllers.first(
            ...
            UserDefaults.standard.set(true, forKey: "scienceLevel5Completed")
            UserDefaults.standard.set(percentage, forKey: "scienceLevel5Percentage")
