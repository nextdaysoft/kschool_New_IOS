...
class RainbowVC: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        setupView(redView)
        setupView(orangeView)
        setupView(yellowView)
        setupView(greenView)
        setupView(blueView)
        setupView(indigoView)
        setupView(violetView)
        ...
        correctMapping = [
            redView: "Red".localiz(),
            orangeView: "Orange".localiz(),
            yellowView: "Yellow".localiz(),
            greenView: "Green".localiz(),
            blueView: "Blue".localiz(),
            indigoView: "Indigo".localiz(),
            violetView: "Violet".localiz()
        ]
    ...
    @IBAction func nextAndUndoTapBtn(_ sender: UIButton) {
        ...
        if let menuVC = navigationController?.viewControllers.first(
            ...
            UserDefaults.standard.set(true, forKey: "scienceLevel11Completed")
            UserDefaults.standard.set(percentage, forKey: "scienceLevel11Percentage")
