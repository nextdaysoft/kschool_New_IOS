...
//  Kids
//
//  Created by Koshal Singh on 23/01/26.
//

import UIKit
import LanguageManager_iOS

class PartsOfDogVC: BaseViewController {

    @IBOutlet weak var eyeView1: UIView!
    @IBOutlet weak var earView3: UIView!
    @IBOutlet weak var tailView4: UIView!
    @IBOutlet weak var legView6: UIView!
    @IBOutlet weak var noseView7: UIView!
    @IBOutlet weak var backView2: UIView!
    @IBOutlet weak var pawView5: UIView!


    @IBOutlet weak var eyesLineView: UIView!
    ...
    override func viewDidLoad() {
        ...
        correctMapping = [
            eyeView1: "Eye".localiz(),
            backView2: "Back".localiz(),
            earView3: "Ear".localiz(),
            tailView4: "Tail".localiz(),
            pawView5: "Paw".localiz(),
            legView6: "Leg".localiz(),
            noseView7: "Nose".localiz()
        ]
