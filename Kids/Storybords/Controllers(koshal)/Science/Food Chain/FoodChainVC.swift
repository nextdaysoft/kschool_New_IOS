...
class FoodChainVC: BaseViewController {

    @IBOutlet weak var producerView: UIView!
    @IBOutlet weak var primaryConsumerView: UIView!
    @IBOutlet weak var secondaryConsumerView: UIView!
    @IBOutlet weak var decomposersView: UIView!
    @IBOutlet weak var apexConsumerView: UIView!
    @IBOutlet weak var tertiaryConsumerView: UIView!
    ...
    override func viewDidLoad() {
        ...
        setupView(producerView)
        setupView(primaryConsumerView)
        setupView(secondaryConsumerView)
        setupView(decomposersView)
        setupView(apexConsumerView)
        setupView(tertiaryConsumerView)
        ...
        allTargetViews = [
            producerView,
            primaryConsumerView,
            secondaryConsumerView,
            decomposersView,
            apexConsumerView,
            tertiaryConsumerView
        ]
        ...
        correctMapping = [
            producerView: "Producer".localiz(),
            primaryConsumerView: "Primary Consumer".localiz(),
            secondaryConsumerView: "Secondary Consumer".localiz(),
            decomposersView: "Decomposers".localiz(),
            apexConsumerView: "Apex Consumer".localiz(),
            tertiaryConsumerView: "Tertiary Consumer".localiz(),
        ]
    ...
    func setupRandomLabels() {
        ...
        let parts = [
            "Producer".localiz(),
            "Primary Consumer".localiz(),
            "Secondary Consumer".localiz(),
            "Decomposers".localiz(),
            "Apex Consumer".localiz(),
            "Tertiary Consumer".localiz()
        ]
    ...
    func checkDrop(_ draggedView: UIView) {
        ...
        let targets: [UIView: UIView] = [
            view1: producerView,
            view2: primaryConsumerView,
            view3: secondaryConsumerView,
            view4: decomposersView,
            view5: apexConsumerView,
            view6: tertiaryConsumerView
        ]
    ...
    @IBAction func nextAndUndoTapBtn(_ sender: UIButton) {
        ...
        if let menuVC = navigationController?.viewControllers.first(
            ...
            UserDefaults.standard.set(true, forKey: "scienceLevel4Completed")
            UserDefaults.standard.set(percentage, forKey: "scienceLevel4Percentage")
