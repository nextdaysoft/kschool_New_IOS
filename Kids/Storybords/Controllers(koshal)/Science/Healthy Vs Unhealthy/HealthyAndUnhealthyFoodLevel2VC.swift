//
//  HealthyAndUnhealthyFoodLevel2VC.swift
//  Kids
//
...
class HealthyAndUnhealthyFoodLevel2VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "healthyVsUnhealthyLevel2Completed")
        UserDefaults.standard.set(percentage, forKey: "healthyVsUnhealthyLevel2Percentage")
    ...
    func setupAnimals() {
        ...
        let foods: [(String, FoodType)] = [
            ...
            ("donut", .unhealthy),
            ("fries", .unhealthy),
            ("chocolate-bar", .unhealthy),
            ("cooking", .unhealthy)
        ]

        let shuffledFoods = foods.shuffled()   // 🔥 shuffle

        foodsItemViews = shuffledFoods.compactMap {
...
// MARK: - Drag Delegate
extension HealthyAndUnhealthyFoodLevel2VC: UIDragInteractionDelegate {
...
// MARK: - Drop Delegate
extension HealthyAndUnhealthyFoodLevel2VC: UIDropInteractionDelegate {
    ...
    func removeAnimalView(_ view: UIView) {
        ...
        foodsItemViews.removeAll { $0 == view }
...
extension HealthyAndUnhealthyFoodLevel2VC {
