//
//  HealthyAndUnhealthyFoodLevel3VC.swift
//  Kids
//
...
class HealthyAndUnhealthyFoodLevel3VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "healthyVsUnhealthyLevel3Completed")
        UserDefaults.standard.set(percentage, forKey: "healthyVsUnhealthyLevel3Percentage")
    ...
    func setupAnimals() {
        ...
        for (index, food) in shuffledFoods.enumerated() {
            if let img = UIImage(named: food.0) {
                ...
                foodsItemViews.append(view)
                originalIndexes[view] = index   // 🔑 index store
            } else {
                print("❌ Image NOT FOUND:", food.0)
            }
        }
        ...
        // 🔥 Save original centers (after layout)
...
// MARK: - Drag Delegate
extension HealthyAndUnhealthyFoodLevel3VC: UIDragInteractionDelegate {
...
// MARK: - Drop Delegate
extension HealthyAndUnhealthyFoodLevel3VC: UIDropInteractionDelegate {
...
extension HealthyAndUnhealthyFoodLevel3VC {
