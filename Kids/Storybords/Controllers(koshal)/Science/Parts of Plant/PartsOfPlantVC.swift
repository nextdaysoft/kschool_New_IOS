...
class PartsOfPlantVC: BaseViewController {

    @IBOutlet weak var leafView1: UIView!
    @IBOutlet weak var stemView2: UIView!
    @IBOutlet weak var flowerView3: UIView!
    @IBOutlet weak var budView4: UIView!
    @IBOutlet weak var rootsview5: UIView!
    ...
    override func viewDidLoad() {
        ...
        setupView(leafView1)
        setupView(stemView2)
        setupView(flowerView3)
        setupView(budView4)
        setupView(rootsview5)
        ...
        correctMapping = [
            leafView1: "Leaf".localiz(),
            stemView2: "Stem".localiz(),
            flowerView3: "Flower".localiz(),
            budView4: "Bud".localiz(),
            rootsview5: "Roots".localiz()
        ]
    ...
    @IBAction func nextAndUndoTapBtn(_ sender: UIButton) {
        ...
        if let menuVC = navigationController?.viewControllers.first(
            ...
            UserDefaults.standard.set(true, forKey: "scienceLevel6Completed")
            UserDefaults.standard.set(percentage, forKey: "scienceLevel6Percentage")
