//
//  HealthyFoodHabitsResultLevel2VC.swift
//  Kids
//
...
class HealthyFoodHabitsResultLevel2VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "healthyFoodLevel2Completed")
        UserDefaults.standard.set(percentage, forKey: "healthyFoodLevel2Percentage")
