...
class PartsOfHumanVC: BaseViewController {
    ...
    @IBOutlet weak var kneeView: UIView!
    ...
    override func viewDidLoad() {
        ...
        correctMapping = [
            chestView: "Chest".localiz(),
            armView: "Arm".localiz(),
            legView: "Leg".localiz(),
            footView: "Foot".localiz(),
            headView: "Head".localiz(),
            shoulderView: "Shoulder".localiz(),
            handView: "Hand".localiz(),
            kneeView: "Knee".localiz()
        ]
    ...
    func updateShowAnswerVisibility() {
        showAnswerBtn.isHidden = !allLabelsPlaced()
    }
        ...
        case .changed:
            ...
            for target in allTargetViews {
                if let shadow = draggingShadowView,
                   shadow.frame.intersects(target.frame) {
    ...
    func addLabelToCenter(
        ...
        label.isUserInteractionEnabled = !lockInteraction   // 🔑 key line
    ...
    @IBAction func nextAndUndoTapBtn(_ sender: UIButton) {
        ...
        if let menuVC = navigationController?.viewControllers.first(
            ...
            // 🔐 SAVE PARTS OF HUMAN – SCIENCE LEVEL 9
            UserDefaults.standard.set(true, forKey: "scienceLevel9Completed")
            UserDefaults.standard.set(percentage, forKey: "scienceLevel9Percentage")
    ...
    @IBAction func showAnswerTapBtn(_ sender: UIButton) {
        ...
        for (targetView, correctText) in correctMapping {
            ...
            NSLayoutConstraint.activate([
                label.centerXAnchor.constraint(equalTo: targetView.centerXAnchor),
                label.centerYAnchor.constraint(equalTo: targetView.centerYAnchor)
            ])
        }
