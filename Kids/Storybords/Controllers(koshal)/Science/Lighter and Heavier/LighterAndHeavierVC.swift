...
class LighterAndHeavierVC: BaseViewController {
    ...
    @IBAction func nextTapBtn(_ sender: UIButton) {
        ...
        // 🔐 SAVE LEVEL 2
        UserDefaults.standard.set(true, forKey: "scienceLevel13Completed")
        UserDefaults.standard.set(percentage, forKey: "scienceLevel13Percentage")
    ...
    func setupAnimals() {
        ...
        foodsItemViews = shuffledItems.compactMap {
...
// MARK: - Drag Delegate
extension LighterAndHeavierVC: UIDragInteractionDelegate {
...
// MARK: - Drop Delegate
extension LighterAndHeavierVC: UIDropInteractionDelegate {
