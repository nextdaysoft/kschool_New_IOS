//
//  ListenHealthyFoodHabitsLevel1VC.swift
//  Kids
//
...
class ListenHealthyFoodHabitsLevel1VC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func startMainFlow() {
        ...
        // ✅ Show arrow hint only after intro screen
    ...
    func showSwipeUpHint() {
        ...
        let label = UILabel()
        label.text = "Swipe up to change Healthy Food Habits".localiz()
    ...
    func restoreCardFromSmall(cardTag: Int) {
        ...
        // Jo items already dikh gaye
        let viewedItems = Array(planets.prefix(currentIndex + 1))

        // Jo remaining hain unko random karo
        var remainingItems = Array(planets.dropFirst(currentIndex + 1))
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "ListenHealthyFoodHabitsResultLevel1VC"
        ) as? ListenHealthyFoodHabitsResultLevel1VC {
    ...
    func createHealthyFoodHabitsPDF() -> URL? {

        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("HealthyFoodHabits.pdf")
    ...
    @IBAction func pdfTapBtn(_ sender: UIButton) {
        ...
        guard let pdfURL = createHealthyFoodHabitsPDF() else { return }
