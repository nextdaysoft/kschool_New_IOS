...
class LearnMonthsShowVC: BaseViewController,AVSpeechSynthesizerDelegate {
    ...
    func showSwipeUpHint() {
        ...
        let label = UILabel()
        label.text = "Swipe up to change months"
    ...
    func animateCardOut() {
        ...
        let currentDay = months[currentIndex]
        ...
        UIView.animate(withDuration: 0.4, animations: {
            ...
            // ✅ End check
            if self.currentIndex >= self.months.count {
    ...
    func updateUI() {
        ...
        guard currentIndex < months.count else { return }

        let day = months[currentIndex]
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnMonthsResultVC"
        ) as? LearnMonthsResultVC {
