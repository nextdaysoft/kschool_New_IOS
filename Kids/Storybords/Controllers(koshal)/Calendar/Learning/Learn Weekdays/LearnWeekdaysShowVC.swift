...
class LearnWeekdaysShowVC: BaseViewController,AVSpeechSynthesizerDelegate  {
    ...
    func showSwipeUpHint() {
        ...
        let label = UILabel()
        label.text = "Swipe up to change week days"
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "LearnWeekdaysResultVC"
        ) as? LearnWeekdaysResultVC {
