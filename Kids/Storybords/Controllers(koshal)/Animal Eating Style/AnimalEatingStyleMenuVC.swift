...
class AnimalEatingStyleMenuVC: BaseViewController {
    ...
    func updateResetVisibility() {
        ...
        let isAnyCompleted =
        UserDefaults.standard.bool(forKey: "animalEatingStyleLevel2Completed")
    ...
    func updateLevelUI(level: Int, imageView: UIImageView, label: UILabel) {
        ...
        let completedKey = "animalEatingStyleLevel\(level)Completed"
        let percentageKey = "animalEatingStyleLevel\(level)Percentage"
    ...
    func setupSubscriptionLock() {
        ...
        UserDefaults.standard.bool(
            forKey: "animalEatingStyleLevel2Completed"
        )

        let percentage =
        UserDefaults.standard.integer(
            forKey: "animalEatingStyleLevel2Percentage"
        )
    ...
    @IBAction func level1TapBtn(_ sender: UIButton) {
        ...
        let vc = storyboard.instantiateViewController(
            withIdentifier: "LearnAnimalEatingStyleVC"
        ) as! LearnAnimalEatingStyleVC
    ...
    @IBAction func level2TapBtn(_ sender: UIButton) {
        ...
        let vc = storyboard.instantiateViewController(
            withIdentifier: "GuessAnimalEatingStyleVC"
        ) as! GuessAnimalEatingStyleVC
