...
class PartsOfHumanBodyVC: BaseViewController {
    ...
    @IBOutlet weak var thighView: UIView!
    ...
    func setupRandomLabels() {
        ...
        let parts = ["Knee", "Head", "Neck", "Leg", "Chest", "Stomach", "Hand", "Shoulder", "Thigh", "Arm", "Foot"]
    ...
    @IBAction func nextAndUndoTapBtn(_ sender: UIButton) {
        ...
        if let menuVC = navigationController?.viewControllers.first(
            ...
            UserDefaults.standard.set(true, forKey: "externalBodyPartsLevel1Completed")
            UserDefaults.standard.set(percentage, forKey: "externalBodyPartsLevel1Percentage")
