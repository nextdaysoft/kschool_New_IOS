...
class PartsOfFaceVC: BaseViewController {
    ...
    @IBOutlet weak var cheekView: UIView!
    @IBOutlet weak var teethView: UIView!
    @IBOutlet weak var lipView: UIView!
    @IBOutlet weak var eyebrowsView: UIView!
    @IBOutlet weak var eyeView: UIView!
    @IBOutlet weak var earView: UIView!
    @IBOutlet weak var noseView: UIView!

    @IBOutlet weak var eyebrowsLineView: UIView!
    ...
    override func viewDidLoad() {
        ...
        eyebrowsLineView.transform = CGAffineTransform(rotationAngle: +0.35)
        ...
        setupView(hairView)
        setupView(chinView)
        setupView(foreheadView)
        setupView(tongueView)
        setupView(cheekView)
        setupView(teethView)
        setupView(lipView)
        setupView(eyebrowsView)
        setupView(eyeView)
        setupView(earView)
        setupView(noseView)
        ...
        label11.tag = gameLabelTag
        
        correctMapping = [
            hairView: "Hair",
            chinView: "Chin",
            foreheadView: "Forehead",
            tongueView: "Tongue",
            cheekView: "Cheek",
            teethView: "Teeth",
            lipView: "Lip",
            eyebrowsView: "Eyebrows",
            eyeView: "Eye",
            earView: "Ear",
            noseView: "Nose",
        ]
    ...
    func setupRandomLabels() {
        ...
        let parts = ["Hair", "Chin", "Forehead", "Tongue", "Cheek", "Teeth", "Lip", "Eyebrows", "Eye", "Ear", "Nose"]
        let shuffledParts = parts.shuffled()

        let labels = [label1, label2, label3, label4, label5, label6, label7, label8, label9, label10, label11]
    ...
    @IBAction func nextAndUndoTapBtn(_ sender: UIButton) {
        ...
        if let menuVC = navigationController?.viewControllers.first(
            ...
            UserDefaults.standard.set(true, forKey: "externalBodyPartsLevel2Completed")
            UserDefaults.standard.set(percentage, forKey: "externalBodyPartsLevel2Percentage")
