...
class PartsOfLegVC: BaseViewController {

    @IBOutlet weak var ankleView: UIView!
    @IBOutlet weak var instepView: UIView!
    @IBOutlet weak var thighView: UIView!
    @IBOutlet weak var heelView: UIView!
    @IBOutlet weak var calfView: UIView!
    @IBOutlet weak var kneeView: UIView!
    @IBOutlet weak var shinView: UIView!
    @IBOutlet weak var toeView: UIView!
    ...
    func setupRandomLabels() {
        ...
        let parts = ["Ankle", "Instep", "Thigh", "Heel", "Calf", "Knee", "Shin", "Toe"]
    ...
    @IBAction func nextAndUndoTapBtn(_ sender: UIButton) {
        ...
        if let menuVC = navigationController?.viewControllers.first(
            ...
            UserDefaults.standard.set(true, forKey: "externalBodyPartsLevel4Completed")
            UserDefaults.standard.set(percentage, forKey: "externalBodyPartsLevel4Percentage")
