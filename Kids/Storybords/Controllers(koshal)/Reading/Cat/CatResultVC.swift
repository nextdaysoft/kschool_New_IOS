...
class CatResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "readingLevel3Completed")
        UserDefaults.standard.set(percentage, forKey: "readingLevel3Percentage")
