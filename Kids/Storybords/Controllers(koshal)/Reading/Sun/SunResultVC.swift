...
class SunResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "readingLevel5Completed")
        UserDefaults.standard.set(percentage, forKey: "readingLevel5Percentage")
