...
class BananaResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "readingLevel10Completed")
        UserDefaults.standard.set(percentage, forKey: "readingLevel10Percentage")
