...
class BananaVC: BaseViewController {
    ...
    var questions: [BananaQuestion] = [

        BananaQuestion(
            storyTitle: "Banana".localiz(),
            storyText: """
            This is a banana.
            ...
            option1: "Apple".localiz(),
            option2: "Banana".localiz(),
            option3: "Mango".localiz(),
            correctAnswer: "Banana".localiz()
        ),
        ...
        BananaQuestion(
            ...
            The banana is soft and sweet.
            """.localiz(),
            question: "How is the banana?".localiz(),
            option1: "Cold and bitter".localiz(),
            option2: "Soft and sweet".localiz(),
            option3: "Hard and sour".localiz(),
            correctAnswer: "Soft and sweet".localiz()
        ),
        ...
        BananaQuestion(
            ...
            The banana is soft and sweet.
            """.localiz(),
            question: "What do I do with the banana?".localiz(),
            option1: "Eat it".localiz(),
            option2: "Kick it".localiz(),
            option3: "Throw it".localiz(),
        ...
        BananaQuestion(
            ...
            The banana is soft and sweet.
            """.localiz(),
            question: "Is the banana yellow or red?".localiz(),
            option1: "Red".localiz(),
            option2: "Purple".localiz(),
        ...
        BananaQuestion(
            ...
            The banana is soft and sweet.
            """.localiz(),
            question: "What color is the banana?".localiz(),
    ...
    func createPDF() -> URL? {
        ...
        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("Banana Reading.pdf")
