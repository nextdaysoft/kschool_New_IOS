...
class FishResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "readingLevel6Completed")
        UserDefaults.standard.set(percentage, forKey: "readingLevel6Percentage")
