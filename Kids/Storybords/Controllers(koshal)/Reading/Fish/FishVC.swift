...
class FishVC: BaseViewController {
    ...
    var questions: [FishQuestion] = [
        ...
        FishQuestion(
            ...
            The fish has fins.
            """.localiz(),
            question: "What can the fish do?".localiz(),
            option1: "Fly".localiz(),
            option2: "Run".localiz(),
            option3: "Swim".localiz(),
            correctAnswer: "Swim".localiz()
        ),
        ...
        FishQuestion(
            ...
            The fish has fins.
            """.localiz(),
            question: "What lives in water?".localiz(),
            option1: "Bird".localiz(),
            option2: "Fish".localiz(),
            option3: "Dog".localiz(),
            correctAnswer: "Fish".localiz()
        ),
        ...
        FishQuestion(
            ...
            The fish has fins.
            """.localiz(),
            question: "What does the fish have?".localiz(),
            option1: "Wings".localiz(),
            option2: "Tail".localiz(),
            option3: "Fins".localiz(),
            correctAnswer: "Fins".localiz()
        ),
        ...
        FishQuestion(
            ...
            The fish has fins.
            """.localiz(),
            question: "Is the fish slow or fast?".localiz(),
            option1: "Fast".localiz(),
            option2: "Slow".localiz(),
            option3: "Lazy".localiz(),
            correctAnswer: "Fast".localiz()
        ),
        ...
        FishQuestion(
            ...
            The fish has fins.
            """.localiz(),
            question: "Where does the fish live?".localiz(),
            option1: "In tree".localiz(),
            option2: "In nest".localiz(),
            option3: "In water".localiz(),
            correctAnswer: "In water".localiz()
        )
    ]
