...
class BirdResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "readingLevel7Completed")
        UserDefaults.standard.set(percentage, forKey: "readingLevel7Percentage")
