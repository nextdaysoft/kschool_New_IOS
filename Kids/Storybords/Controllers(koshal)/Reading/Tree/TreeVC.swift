...
class TreeVC: BaseViewController {
    ...
    var questions: [TreeQuestion] = [

        TreeQuestion(
            storyTitle: "Tree".localiz(),
            storyText: """
            This is a tree.
            The tree is green.
            It gives us shade.
            Birds make nests on the tree.
            """.localiz(),
            question: "Who makes nests on the tree?".localiz(),
            option1: "Cats".localiz(),
            option2: "Dogs".localiz(),
            option3: "Birds".localiz(),
            correctAnswer: "Birds".localiz()
        ),
        ...
        TreeQuestion(
            ...
            Birds make nests on the tree.
            """.localiz(),
            question: "Is the tree green or brown?".localiz(),
            option1: "Black".localiz(),
            option2: "Blue".localiz(),
            option3: "Green".localiz(),
            correctAnswer: "Green".localiz()
        ),
        ...
        TreeQuestion(
            ...
            Birds make nests on the tree.
            """.localiz(),
            question: "What does the tree give us?".localiz(),
            option1: "Food".localiz(),
            option2: "Shade".localiz(),
            option3: "Water".localiz(),
            correctAnswer: "Shade".localiz()
        ),
        ...
        TreeQuestion(
            ...
            Birds make nests on the tree.
            """.localiz(),
            question: "How is the tree?".localiz(),
            option1: "Small".localiz(),
            option2: "Short".localiz(),
            option3: "Big".localiz(),
            correctAnswer: "Big".localiz()
        ),
        ...
        TreeQuestion(
            ...
            Birds make nests on the tree.
            """.localiz(),
            question: "What is green in the story?".localiz(),
            option1: "Sun".localiz(),
            option2: "Tree".localiz(),
            option3: "Moon".localiz(),
            correctAnswer: "Tree".localiz()
        )
    ]
    ...
    func createPDF() -> URL? {
        ...
        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("Tree Reading.pdf")
