...
class TreeResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "readingLevel9Completed")
        UserDefaults.standard.set(percentage, forKey: "readingLevel9Percentage")
