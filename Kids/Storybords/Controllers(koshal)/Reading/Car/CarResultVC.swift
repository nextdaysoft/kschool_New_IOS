...
class CarResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "readingLevel8Completed")
        UserDefaults.standard.set(percentage, forKey: "readingLevel8Percentage")
