...
class AppleVC: BaseViewController {
    ...
    var questions: [AppleQuestion] = [
        ...
        AppleQuestion(
            ...
            The apple is sweet.
            """.localiz(),
            question: "What do I do with the apple?".localiz(),
            option1: "Throw it".localiz(),
            option2: "Eat it".localiz(),
            option3: "Kick it".localiz(),
            correctAnswer: "Eat it".localiz()
        ),
        ...
        AppleQuestion(
            ...
            The apple is sweet.
            """.localiz(),
            question: "What fruit is in the story?".localiz(),
            option1: "Mango".localiz(),
            option2: "Orange".localiz(),
            option3: "Apple".localiz(),
            correctAnswer: "Apple".localiz()
        ),
        ...
        AppleQuestion(
            ...
            The apple is sweet.
            """.localiz(),
            question: "How does the apple taste?".localiz(),
            option1: "Salty".localiz(),
            option2: "Sour".localiz(),
            option3: "Sweet".localiz(),
        ...
        AppleQuestion(
            ...
            The apple is sweet.
            """.localiz(),
            question: "Is the apple red or yellow?".localiz(),
            option1: "Purple".localiz(),
        ...
        AppleQuestion(
            ...
            The apple is sweet.
            """.localiz(),
            question: "What color is the apple?".localiz(),
            option1: "Green".localiz(),
            option2: "Blue".localiz(),
            option3: "Red".localiz(),
            correctAnswer: "Red".localiz()
        )
    ]
    ...
    func createPDF() -> URL? {
        ...
        let pdfURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("Apple Reading.pdf")
        ...
        do {
            ...
            try pdfRenderer.writePDF(to: pdfURL) { context in
                ...
                let scale = min(
                    pageRect.width / imageSize.width,
                ...
                let drawRect = CGRect(
                    x: (pageRect.width - drawWidth) / 2,
                    y: (pageRect.height - drawHeight) / 2,
                    width: drawWidth,
                    height: drawHeight
                )
