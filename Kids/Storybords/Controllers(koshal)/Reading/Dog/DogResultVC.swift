...
class DogResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "readingLevel2Completed")
        UserDefaults.standard.set(percentage, forKey: "readingLevel2Percentage")
