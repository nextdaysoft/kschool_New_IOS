...
class SeasonsMenuVC: BaseViewController {
    ...
    func updateResetVisibility() {
        ...
        let isAnyCompleted =
        UserDefaults.standard.bool(forKey: "seasonsLevel2Completed")
    ...
    func updateLevelUI(level: Int, imageView: UIImageView, label: UILabel) {
        ...
        let completedKey = "seasonsLevel\(level)Completed"
        let percentageKey = "seasonsLevel\(level)Percentage"
    ...
    func setupSubscriptionLock() {
        ...
        UserDefaults.standard.bool(
            forKey: "seasonsLevel2Completed"
        )

        let percentage =
        UserDefaults.standard.integer(
            forKey: "seasonsLevel2Percentage"
        )
    ...
    @IBAction func level2TapBtn(_ sender: UIButton) {
        ...
        let vc = storyboard.instantiateViewController(
            withIdentifier: "MatchTheSeasonVC"
        ) as! MatchTheSeasonVC
