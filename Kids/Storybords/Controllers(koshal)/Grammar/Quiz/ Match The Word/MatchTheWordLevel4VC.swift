...
class MatchTheWordLevel4VC: BaseViewController {
    ...
    var correctWordMap: [String: String] = [
        "Brush".localiz(): "your teeth".localiz(),
        "Wash".localiz(): "your hands".localiz(),
        "Read".localiz(): "a book".localiz(),
        "Drink".localiz(): "water".localiz(),
        "Write".localiz(): "your notebook".localiz()
    ]

    let wordPairs: [WordPair] = [
        WordPair(first: "Brush".localiz(), last: "your teeth".localiz()),
        WordPair(first: "Wash".localiz(), last: "your hands".localiz()),
        WordPair(first: "Read".localiz(), last: "a book".localiz()),
        WordPair(first: "Drink".localiz(), last: "water".localiz()),
        WordPair(first: "Write".localiz(), last: "your notebook".localiz())
    ]
    ...
    @IBAction func submitAndNextTapBtn(_ sender: UIButton) {
        ...
        if isSubmitted {
            ...
            UserDefaults.standard.set(true, forKey: "matchTheWordLevel4Completed")
            UserDefaults.standard.set(percentage, forKey: "matchTheWordLevel4Percentage")
