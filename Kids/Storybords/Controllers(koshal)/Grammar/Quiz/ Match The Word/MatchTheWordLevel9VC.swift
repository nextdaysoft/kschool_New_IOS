...
class MatchTheWordLevel9VC: BaseViewController {
    ...
    var correctWordMap: [String: String] = [
        "Go".localiz(): "to the tree".localiz(),
        "Walk".localiz(): "to the playground".localiz(),
        "Run".localiz(): "at the board".localiz(),
        "Jump".localiz(): "over the rope".localiz(),
        "Look".localiz(): "around the circle".localiz()
    ]

    let wordPairs: [WordPair] = [
        WordPair(first: "Go".localiz(), last: "to the tree".localiz()),
        WordPair(first: "Walk".localiz(), last: "to the playground".localiz()),
        WordPair(first: "Run".localiz(), last: "at the board".localiz()),
        WordPair(first: "Jump".localiz(), last: "over the rope".localiz()),
        WordPair(first: "Look".localiz(), last: "around the circle".localiz())
    ]
    ...
    @IBAction func submitAndNextTapBtn(_ sender: UIButton) {
        ...
        if isSubmitted {
            ...
            UserDefaults.standard.set(true, forKey: "matchTheWordLevel9Completed")
            UserDefaults.standard.set(percentage, forKey: "matchTheWordLevel9Percentage")
