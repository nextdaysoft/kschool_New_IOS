...
class MatchTheWordLevel8VC: BaseViewController {
    ...
    var correctWordMap: [String: String] = [
        "Move".localiz(): "the box".localiz(),
        "Pull".localiz(): "back".localiz(),
        "Push".localiz(): "down".localiz(),
        "Drop".localiz(): "the door".localiz(),
        "Lift".localiz(): "up".localiz()
    ]

    let wordPairs: [WordPair] = [
        WordPair(first: "Move".localiz(), last: "the box".localiz()),
        WordPair(first: "Pull".localiz(), last: "back".localiz()),
        WordPair(first: "Push".localiz(), last: "down".localiz()),
        WordPair(first: "Drop".localiz(), last: "the door".localiz()),
        WordPair(first: "Lift".localiz(), last: "up".localiz())
    ]
    ...
    @IBAction func submitAndNextTapBtn(_ sender: UIButton) {
        ...
        if isSubmitted {
            ...
            UserDefaults.standard.set(true, forKey: "matchTheWordLevel8Completed")
            UserDefaults.standard.set(percentage, forKey: "matchTheWordLevel8Percentage")
