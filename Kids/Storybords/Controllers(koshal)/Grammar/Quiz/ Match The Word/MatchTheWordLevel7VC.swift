...
class MatchTheWordLevel7VC: BaseViewController {
    ...
    var correctWordMap: [String: String] = [
        "Play".localiz(): "in the yard".localiz(),
        "Paste".localiz(): "on the paper".localiz(),
        "Roll".localiz(): "on the floor".localiz(),
        "Build".localiz(): "with blocks".localiz(),
        "Talk".localiz(): "softly".localiz()
    ]

    let wordPairs: [WordPair] = [
        WordPair(first: "Play".localiz(), last: "in the yard".localiz()),
        WordPair(first: "Paste".localiz(), last: "on the paper".localiz()),
        WordPair(first: "Roll".localiz(), last: "on the floor".localiz()),
        WordPair(first: "Build".localiz(), last: "with blocks".localiz()),
        WordPair(first: "Talk".localiz(), last: "softly".localiz())
    ]
    ...
    @IBAction func submitAndNextTapBtn(_ sender: UIButton) {
        ...
        if isSubmitted {
            ...
            UserDefaults.standard.set(true, forKey: "matchTheWordLevel7Completed")
            UserDefaults.standard.set(percentage, forKey: "matchTheWordLevel7Percentage")
