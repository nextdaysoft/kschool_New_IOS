...
class MatchTheWordLevel10VC: BaseViewController {
    ...
    var correctWordMap: [String: String] = [
        "Follow".localiz(): "the rules".localiz(),
        "Share".localiz(): "the pair of socks".localiz(),
        "Clean".localiz(): "the room".localiz(),
        "Answer".localiz(): "the question".localiz(),
        "Match".localiz(): "your toys".localiz()
    ]

    let wordPairs: [WordPair] = [
        WordPair(first: "Follow".localiz(), last: "the rules".localiz()),
        WordPair(first: "Share".localiz(), last: "the pair of socks".localiz()),
        WordPair(first: "Clean".localiz(), last: "the room".localiz()),
        WordPair(first: "Answer".localiz(), last: "the question".localiz()),
        WordPair(first: "Match".localiz(), last: "your toys".localiz())
    ]
    ...
    @IBAction func submitAndNextTapBtn(_ sender: UIButton) {
        ...
        if isSubmitted {
            ...
            UserDefaults.standard.set(true, forKey: "matchTheWordLevel10Completed")
            UserDefaults.standard.set(percentage, forKey: "matchTheWordLevel10Percentage")
