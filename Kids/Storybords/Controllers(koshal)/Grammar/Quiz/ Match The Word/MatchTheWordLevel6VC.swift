...
class MatchTheWordLevel6VC: BaseViewController {
    ...
    var correctWordMap: [String: String] = [
        "Listen".localiz(): "a song".localiz(),
        "Help".localiz(): "a friend".localiz(),
        "Cry".localiz(): "sadly".localiz(),
        "Sing".localiz(): "carefully".localiz(),
        "Cut".localiz(): "the paper".localiz()
    ]

    let wordPairs: [WordPair] = [
        WordPair(first: "Listen".localiz(), last: "a song".localiz()),
        WordPair(first: "Help".localiz(), last: "a friend".localiz()),
        WordPair(first: "Cry".localiz(), last: "sadly".localiz()),
        WordPair(first: "Sing".localiz(), last: "carefully".localiz()),
        WordPair(first: "Cut".localiz(), last: "the paper".localiz())
    ]
    ...
    @IBAction func submitAndNextTapBtn(_ sender: UIButton) {
        ...
        if isSubmitted {
            ...
            UserDefaults.standard.set(true, forKey: "matchTheWordLevel6Completed")
            UserDefaults.standard.set(percentage, forKey: "matchTheWordLevel6Percentage")
