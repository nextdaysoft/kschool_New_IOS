...
class MatchTheWordLevel5VC: BaseViewController {
    ...
    var correctWordMap: [String: String] = [
        "Color".localiz(): "around you".localiz(),
        "Count".localiz(): "1 to 5".localiz(),
        "Speak".localiz(): "loudly".localiz(),
        "Look".localiz(): "the paper".localiz(),
        "Laugh".localiz(): "happily".localiz()
    ]

    let wordPairs: [WordPair] = [
        WordPair(first: "Color".localiz(), last: "around you".localiz()),
        WordPair(first: "Count".localiz(), last: "1 to 5".localiz()),
        WordPair(first: "Speak".localiz(), last: "loudly".localiz()),
        WordPair(first: "Look".localiz(), last: "the paper".localiz()),
        WordPair(first: "Laugh".localiz(), last: "happily".localiz())
    ]
    ...
    @IBAction func submitAndNextTapBtn(_ sender: UIButton) {
        ...
        if isSubmitted {
            ...
            UserDefaults.standard.set(true, forKey: "matchTheWordLevel5Completed")
            UserDefaults.standard.set(percentage, forKey: "matchTheWordLevel5Percentage")
