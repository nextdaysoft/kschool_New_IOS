...
class MatchTheWordLevel1VC: BaseViewController {
    ...
    var correctWordMap: [String: String] = [
        ...
        "Run".localiz(): "fast".localiz(),
        "Jump".localiz(): "high".localiz(),
        "Sit".localiz(): "down".localiz(),
        "Clap".localiz(): "hands together".localiz()
    ]

    let wordPairs: [WordPair] = [
        WordPair(first: "Stand".localiz(), last: "up".localiz()),
        WordPair(first: "Run".localiz(), last: "fast".localiz()),
        WordPair(first: "Jump".localiz(), last: "high".localiz()),
        WordPair(first: "Sit".localiz(), last: "down".localiz()),
        WordPair(first: "Clap".localiz(), last: "hands together".localiz())
    ]
    ...
    @IBAction func submitAndNextTapBtn(_ sender: UIButton) {
        ...
        if isSubmitted {
            ...
            UserDefaults.standard.set(true, forKey: "matchTheWordLevel1Completed")
            UserDefaults.standard.set(percentage, forKey: "matchTheWordLevel1Percentage")
