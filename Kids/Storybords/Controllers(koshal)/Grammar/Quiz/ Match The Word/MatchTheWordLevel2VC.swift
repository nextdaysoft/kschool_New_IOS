...
class MatchTheWordLevel2VC: BaseViewController {
    ...
    var correctWordMap: [String: String] = [
        "Wave".localiz(): "hello".localiz(),
        "Kick".localiz(): "the ball".localiz(),
        "Walk".localiz(): "slowly".localiz(),
        "Open".localiz(): "the door".localiz(),
        "Draw".localiz(): "a picture".localiz()
    ]

    let wordPairs: [WordPair] = [
        WordPair(first: "Wave".localiz(), last: "hello".localiz()),
        WordPair(first: "Kick".localiz(), last: "the ball".localiz()),
        WordPair(first: "Walk".localiz(), last: "slowly".localiz()),
        WordPair(first: "Open".localiz(), last: "the door".localiz()),
        WordPair(first: "Draw".localiz(), last: "a picture".localiz())
    ]
    ...
    @IBAction func submitAndNextTapBtn(_ sender: UIButton) {
        ...
        if isSubmitted {
            ...
            UserDefaults.standard.set(true, forKey: "matchTheWordLevel2Completed")
            UserDefaults.standard.set(percentage, forKey: "matchTheWordLevel2Percentage")
