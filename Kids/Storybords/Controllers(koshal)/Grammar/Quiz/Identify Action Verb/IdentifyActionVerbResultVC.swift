//
//  IdentifyActionVerbResultVC.swift
//  Kids
//
...
class IdentifyActionVerbResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "identifyActionVerbLevel6Completed")
        UserDefaults.standard.set(percentage, forKey: "identifyActionVerbLevel6Percentage")
