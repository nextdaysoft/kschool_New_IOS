...
class ProperNounResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "properNounLevel8Completed")
        UserDefaults.standard.set(percentage, forKey: "properNounLevel8Percentage")
