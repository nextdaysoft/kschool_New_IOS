//
//  OrderSentenceResultLevel2VC.swift
//  Kids
//
...
class OrderSentenceResultLevel2VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "orderSentenceLevel2Completed")
        UserDefaults.standard.set(percentage, forKey: "orderSentenceLevel2Percentage")
