//
//  OrderSentenceResultLevel3VC.swift
//  Kids
//
...
class OrderSentenceResultLevel3VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "orderSentenceLevel3Completed")
        UserDefaults.standard.set(percentage, forKey: "orderSentenceLevel3Percentage")
