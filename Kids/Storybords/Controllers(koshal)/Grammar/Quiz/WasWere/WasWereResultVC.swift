...
class WasWereResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "wasWereLevel5Completed")
        UserDefaults.standard.set(percentage, forKey: "wasWereLevel5Percentage")
