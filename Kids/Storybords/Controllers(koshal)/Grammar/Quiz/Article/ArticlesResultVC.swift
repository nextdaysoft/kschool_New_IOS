...
class ArticlesResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "articleLevel7Completed")
        UserDefaults.standard.set(percentage, forKey: "articleLevel7Percentage")
