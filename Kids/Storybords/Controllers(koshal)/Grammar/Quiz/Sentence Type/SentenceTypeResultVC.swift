...
class SentenceTypeResultVC: BaseViewController {
    ...
    func goToMenu() {
        ...
        // 🔐 SAVE SENTENCE TYPE – LEVEL 1
        UserDefaults.standard.set(true, forKey: "sentenceTypeLevel3Completed")
        UserDefaults.standard.set(percentage, forKey: "sentenceTypeLevel3Percentage")
