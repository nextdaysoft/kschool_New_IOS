//
//  RhymingWordsResultLevel3VC.swift
//  Kids
//
...
class RhymingWordsResultLevel3VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "rhymingWordsLevel3Completed")
        UserDefaults.standard.set(percentage, forKey: "rhymingWordsLevel3Percentage")
