//
//  RhymingWordsResultLevel2VC.swift
//  Kids
//
...
class RhymingWordsResultLevel2VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "rhymingWordsLevel2Completed")
        UserDefaults.standard.set(percentage, forKey: "rhymingWordsLevel2Percentage")
