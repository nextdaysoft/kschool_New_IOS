//
//  RhymingWordsResultLevel1VC.swift
//  Kids
//
...
class RhymingWordsResultLevel1VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "rhymingWordsLevel1Completed")
        UserDefaults.standard.set(percentage, forKey: "rhymingWordsLevel1Percentage")

        if let menuVC = navigationController?.viewControllers.first(
            where: { $0 is RhymingWordsMenuVC }
