//
//  PickTheCorrectSpellingResultLevel3VC.swift
//  Kids
//
...
class PickTheCorrectSpellingResultLevel3VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "pickCorrectSpellingLevel3Completed")
        UserDefaults.standard.set(percentage, forKey: "pickCorrectSpellingLevel3Percentage")
