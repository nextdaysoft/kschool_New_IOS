//
//  PickTheCorrectSpellingLevel5VC.swift
//  Kids
//
...
class PickTheCorrectSpellingLevel5VC: BaseViewController {
    ...
    @IBAction func nextTapBtn(_ sender: UIButton) {
        ...
        if currentIndex < questions.count {
            ...
            let vc = storyboard.instantiateViewController(
                withIdentifier: "PickTheCorrectSpellingResultLevel5VC"
            ) as! PickTheCorrectSpellingResultLevel5VC
