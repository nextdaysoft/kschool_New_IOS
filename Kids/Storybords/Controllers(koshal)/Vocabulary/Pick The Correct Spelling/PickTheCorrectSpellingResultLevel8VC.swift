//
//  PickTheCorrectSpellingResultLevel8VC.swift
//  Kids
//
...
class PickTheCorrectSpellingResultLevel8VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "pickCorrectSpellingLevel8Completed")
        UserDefaults.standard.set(percentage, forKey: "pickCorrectSpellingLevel8Percentage")
