//
//  PickTheCorrectSpellingResultLevel9VC.swift
//  Kids
//
...
class PickTheCorrectSpellingResultLevel9VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "pickCorrectSpellingLevel9Completed")
        UserDefaults.standard.set(percentage, forKey: "pickCorrectSpellingLevel9Percentage")
