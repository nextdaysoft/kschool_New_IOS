//
//  PickTheCorrectSpellingResultLevel5VC.swift
//  Kids
//
...
class PickTheCorrectSpellingResultLevel5VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "pickCorrectSpellingLevel5Completed")
        UserDefaults.standard.set(percentage, forKey: "pickCorrectSpellingLevel5Percentage")
