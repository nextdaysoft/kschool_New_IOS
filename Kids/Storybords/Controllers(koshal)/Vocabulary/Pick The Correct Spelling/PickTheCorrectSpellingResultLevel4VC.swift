//
//  PickTheCorrectSpellingResultLevel4VC.swift
//  Kids
//
...
class PickTheCorrectSpellingResultLevel4VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "pickCorrectSpellingLevel4Completed")
        UserDefaults.standard.set(percentage, forKey: "pickCorrectSpellingLevel4Percentage")
