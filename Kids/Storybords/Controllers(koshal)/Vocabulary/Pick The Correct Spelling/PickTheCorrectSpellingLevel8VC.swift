//
//  PickTheCorrectSpellingLevel8VC.swift
//  Kids
//
...
class PickTheCorrectSpellingLevel8VC: BaseViewController {
    ...
    @IBAction func nextTapBtn(_ sender: UIButton) {
        ...
        if currentIndex < questions.count {
            ...
            let vc = storyboard.instantiateViewController(
                withIdentifier: "PickTheCorrectSpellingResultLevel8VC"
            ) as! PickTheCorrectSpellingResultLevel8VC
