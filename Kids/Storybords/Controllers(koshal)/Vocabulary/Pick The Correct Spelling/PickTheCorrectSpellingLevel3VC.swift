//
//  PickTheCorrectSpellingLevel3VC.swift
//  Kids
//
...
class PickTheCorrectSpellingLevel3VC: BaseViewController {
    ...
    var questions = [
        ...
        ("helicoptr", "helicopter", "helicopter"),
        ("kar", "car", "car"),
        ("train", "trane", "train"),
        ("boat", "boet", "boat"),
        ("motorcycle", "motorcicle", "motorcycle"),
        ("plain", "plane", "plane"),
        ("truck", "truk", "truck"),
        ("buss", "bus", "bus"),
        ("bicycle", "bisycle", "bicycle"),
    ]
    ...
    @IBAction func nextTapBtn(_ sender: UIButton) {
        ...
        if currentIndex < questions.count {
            ...
            let vc = storyboard.instantiateViewController(
                withIdentifier: "PickTheCorrectSpellingResultLevel3VC"
            ) as! PickTheCorrectSpellingResultLevel3VC
