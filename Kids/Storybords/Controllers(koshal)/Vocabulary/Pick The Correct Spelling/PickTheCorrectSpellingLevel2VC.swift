//
//  PickTheCorrectSpellingLevel2VC.swift
//  Kids
//
...
class PickTheCorrectSpellingLevel2VC: BaseViewController {
    ...
    var questions = [
        ...
        ("apple", "aple", "apple"),
        ("strawbery", "strawberry", "strawberry"),
        ("grape", "grap", "grape"),
        ("oranj", "orange", "orange"),
        ("paer", "pear", "pear"),
        ("banana", "bananna", "banana"),
        ("watermalon", "watermelon", "watermelon"),
        ("mango", "mengo", "mango"),
    ]
    ...
    @IBAction func nextTapBtn(_ sender: UIButton) {
        ...
        if currentIndex < questions.count {
            ...
            let vc = storyboard.instantiateViewController(
                withIdentifier: "PickTheCorrectSpellingResultLevel2VC"
            ) as! PickTheCorrectSpellingResultLevel2VC
