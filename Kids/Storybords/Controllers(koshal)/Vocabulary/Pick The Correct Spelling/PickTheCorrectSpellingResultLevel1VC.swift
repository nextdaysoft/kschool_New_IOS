//
//  PickTheCorrectSpellingResultVC.swift
//  Find Pair
//
...
class PickTheCorrectSpellingResultLevel1VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "pickCorrectSpellingLevel1Completed")
        UserDefaults.standard.set(percentage, forKey: "pickCorrectSpellingLevel1Percentage")
