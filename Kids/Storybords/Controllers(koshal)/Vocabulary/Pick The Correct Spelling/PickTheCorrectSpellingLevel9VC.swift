//
//  PickTheCorrectSpellingLevel9VC.swift
//  Kids
//
...
class PickTheCorrectSpellingLevel9VC: BaseViewController {
    ...
    // MARK: - Data
    var questions = [
        ("pensil", "pencil", "pencil"),
        ("bagg", "bag", "bag"),
        ("dask", "desk", "desk"),
        ("rular", "ruler", "ruler"),
        ("book", "buk", "book"),
        ("pen", "pan", "pen"),
        ("sharpener", "sharpenr", "sharpener"),
        ("notebook", "notebuk", "notebook"),
        ("eraser", "erazer", "eraser"),
        ("crayon", "crayonn", "crayon")
    ]
    ...
    @IBAction func nextTapBtn(_ sender: UIButton) {
        ...
        if currentIndex < questions.count {
            ...
            let vc = storyboard.instantiateViewController(
                withIdentifier: "PickTheCorrectSpellingResultLevel9VC"
            ) as! PickTheCorrectSpellingResultLevel9VC
