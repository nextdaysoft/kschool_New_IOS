//
//  PickTheCorrectSpellingVC.swift
//  Find Pair
//
//  Created by Koshal Singh on 26/12/25.
//
import LanguageManager_iOS
struct PickSpellingResult {
...
class PickTheCorrectSpellingLevel1VC: BaseViewController {
    ...
    @IBAction func nextTapBtn(_ sender: UIButton) {
        ...
        if currentIndex < questions.count {
            ...
            let vc = storyboard.instantiateViewController(
                withIdentifier: "PickTheCorrectSpellingResultLevel1VC"
            ) as! PickTheCorrectSpellingResultLevel1VC
