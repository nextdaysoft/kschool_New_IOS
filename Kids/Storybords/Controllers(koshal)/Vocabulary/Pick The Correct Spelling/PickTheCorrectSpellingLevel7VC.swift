//
//  PickTheCorrectSpellingLevel7VC.swift
//  Kids
//
...
class PickTheCorrectSpellingLevel7VC: BaseViewController {
    ...
    @IBAction func nextTapBtn(_ sender: UIButton) {
        ...
        if currentIndex < questions.count {
            ...
            let vc = storyboard.instantiateViewController(
                withIdentifier: "PickTheCorrectSpellingResultLevel7VC"
            ) as! PickTheCorrectSpellingResultLevel7VC
