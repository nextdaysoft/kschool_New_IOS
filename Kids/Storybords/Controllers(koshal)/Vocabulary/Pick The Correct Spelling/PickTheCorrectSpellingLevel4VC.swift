//
//  PickTheCorrectSpellingLevel4VC.swift
//  Kids
//
...
class PickTheCorrectSpellingLevel4VC: BaseViewController {
    ...
    @IBAction func nextTapBtn(_ sender: UIButton) {
        ...
        if currentIndex < questions.count {
            ...
            let vc = storyboard.instantiateViewController(
                withIdentifier: "PickTheCorrectSpellingResultLevel4VC"
            ) as! PickTheCorrectSpellingResultLevel4VC
