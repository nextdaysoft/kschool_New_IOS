//
//  PickTheCorrectSpellingResultLevel6VC.swift
//  Kids
//
...
class PickTheCorrectSpellingResultLevel6VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "pickCorrectSpellingLevel6Completed")
        UserDefaults.standard.set(percentage, forKey: "pickCorrectSpellingLevel6Percentage")
