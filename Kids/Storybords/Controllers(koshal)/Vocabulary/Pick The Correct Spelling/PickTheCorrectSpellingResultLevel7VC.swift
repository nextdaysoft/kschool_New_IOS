//
//  PickTheCorrectSpellingResultLevel7VC.swift
//  Kids
//
...
class PickTheCorrectSpellingResultLevel7VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "pickCorrectSpellingLevel7Completed")
        UserDefaults.standard.set(percentage, forKey: "pickCorrectSpellingLevel7Percentage")
