//
//  PickTheCorrectSpellingResultLevel2VC.swift
//  Kids
//
...
class PickTheCorrectSpellingResultLevel2VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "pickCorrectSpellingLevel2Completed")
        UserDefaults.standard.set(percentage, forKey: "pickCorrectSpellingLevel2Percentage")
