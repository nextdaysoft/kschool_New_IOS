...
class AnimalMovementLevel1VC: BaseViewController {
    ...
    var correctWordMap: [String: String] = [
        "Cat".localiz(): "Meow".localiz(),
        "Fish".localiz(): "Swim".localiz(),
        "Dog".localiz(): "Bark".localiz(),
        "Bird".localiz(): "Fly".localiz(),
        "Frog".localiz(): "Jump".localiz()
    ]

    let wordPairs: [AnimalMovement] = [
        AnimalMovement(first: "Cat".localiz(), last: "Meow".localiz()),
        AnimalMovement(first: "Fish".localiz(), last: "Swim".localiz()),
        AnimalMovement(first: "Dog".localiz(), last: "Bark".localiz()),
        AnimalMovement(first: "Bird".localiz(), last: "Fly".localiz()),
        AnimalMovement(first: "Frog".localiz(), last: "Jump".localiz())
    ]
    ...
    @IBAction func submitAndNextTapBtn(_ sender: UIButton) {
        ...
        if isSubmitted {
            ...
            UserDefaults.standard.set(true, forKey: "animalMovementLevel1Completed")
            UserDefaults.standard.set(percentage, forKey: "animalMovementLevel1Percentage")
