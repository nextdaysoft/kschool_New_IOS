...
class AnimalMovementLevel3VC: BaseViewController {
    ...
    var correctWordMap: [String: String] = [
        "Lion".localiz(): "Roar".localiz(),
        "Monkey".localiz(): "Swing".localiz(),
        "Penguin".localiz(): "Waddle".localiz(),
        "Elephant".localiz(): "Trumpet".localiz(),
        "Crab".localiz(): "Creep".localiz()
    ]

    let wordPairs: [AnimalMovement] = [
        AnimalMovement(first: "Lion".localiz(), last: "Roar".localiz()),
        AnimalMovement(first: "Monkey".localiz(), last: "Swing".localiz()),
        AnimalMovement(first: "Penguin".localiz(), last: "Waddle".localiz()),
        AnimalMovement(first: "Elephant".localiz(), last: "Trumpet".localiz()),
        AnimalMovement(first: "Crab".localiz(), last: "Creep".localiz())
    ]
    ...
    @IBAction func submitAndNextTapBtn(_ sender: UIButton) {
        ...
        if isSubmitted {
            ...
            UserDefaults.standard.set(true, forKey: "animalMovementLevel3Completed")
            UserDefaults.standard.set(percentage, forKey: "animalMovementLevel3Percentage")
