...
class MatchAntonymsLevel3VC: BaseViewController {
    ...
    var correctWordMap: [String: String] = [
        "Early".localiz(): "Late".localiz(),
        "Strong".localiz(): "Weak".localiz(),
        "Inside".localiz(): "Outside".localiz(),
        "Near".localiz(): "Far".localiz(),
        "Start".localiz(): "Stop".localiz()
    ]

    let wordPairs: [WordPairForAntonym] = [
        WordPairForAntonym(first: "Early".localiz(), last: "Late".localiz()),
        WordPairForAntonym(first: "Strong".localiz(), last: "Weak".localiz()),
        WordPairForAntonym(first: "Inside".localiz(), last: "Outside".localiz()),
        WordPairForAntonym(first: "Near".localiz(), last: "Far".localiz()),
        WordPairForAntonym(first: "Start".localiz(), last: "Stop".localiz())
    ]
    ...
    @IBAction func submitAndNextTapBtn(_ sender: UIButton) {
        ...
        if isSubmitted {
            ...
            UserDefaults.standard.set(true, forKey: "matchAntonymsLevel3Completed")
            UserDefaults.standard.set(percentage, forKey: "matchAntonymsLevel3Percentage")
