...
class MatchAntonymsLevel2VC: BaseViewController {
    ...
    var correctWordMap: [String: String] = [
        "Young".localiz(): "Old".localiz(),
        "Open".localiz(): "Close".localiz(),
        "Clean".localiz(): "Dirty".localiz(),
        "Full".localiz(): "Empty".localiz(),
        "Tall".localiz(): "Short".localiz()
    ]

    let wordPairs: [WordPairForAntonym] = [
        WordPairForAntonym(first: "Young".localiz(), last: "Old".localiz()),
        WordPairForAntonym(first: "Open".localiz(), last: "Close".localiz()),
        WordPairForAntonym(first: "Clean".localiz(), last: "Dirty".localiz()),
        WordPairForAntonym(first: "Full".localiz(), last: "Empty".localiz()),
        WordPairForAntonym(first: "Tall".localiz(), last: "Short".localiz())
    ]
    ...
    @IBAction func submitAndNextTapBtn(_ sender: UIButton) {
        ...
        if isSubmitted {
            ...
            UserDefaults.standard.set(true, forKey: "matchAntonymsLevel2Completed")
            UserDefaults.standard.set(percentage, forKey: "matchAntonymsLevel2Percentage")
