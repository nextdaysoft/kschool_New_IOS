//
//  PickTheCorrectOptionResultVC.swift
//  Find Pair
//
...
class PickTheCorrectOptionResultLevel1VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "pickCorrectOptionLevel1Completed")
        UserDefaults.standard.set(percentage, forKey: "pickCorrectOptionLevel1Percentage")
