//
//  PickTheCorrectOptionResultLevel2VC.swift
//  Kids
//
...
class PickTheCorrectOptionResultLevel2VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "pickCorrectOptionLevel2Completed")
        UserDefaults.standard.set(percentage, forKey: "pickCorrectOptionLevel2Percentage")

        if let menuVC = navigationController?.viewControllers.first(
            where: { $0 is PickTheCorrectOptionMenuVC }
        ) {
