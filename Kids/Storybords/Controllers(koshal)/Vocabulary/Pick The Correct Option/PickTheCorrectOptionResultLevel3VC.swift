//
//  PickTheCorrectOptionResultLevel3VC.swift
//  Kids
//
...
class PickTheCorrectOptionResultLevel3VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "pickCorrectOptionLevel3Completed")
        UserDefaults.standard.set(percentage, forKey: "pickCorrectOptionLevel3Percentage")
