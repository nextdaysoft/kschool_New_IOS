...
struct FourLetterWordResultLevel1 {
...
class FourLetterWordLevel1VC: BaseViewController {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "FourLetterWordResultLevel1VC"
        ) as? FourLetterWordResultLevel1VC {
