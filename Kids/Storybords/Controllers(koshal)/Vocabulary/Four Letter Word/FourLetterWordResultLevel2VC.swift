//
//  FourLetterWordResultLevel2VC.swift
//  Kids
//
...
class FourLetterWordResultLevel2VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "fourLetterWordLevel2Completed")
        UserDefaults.standard.set(percentage, forKey: "fourLetterWordLevel2Percentage")
