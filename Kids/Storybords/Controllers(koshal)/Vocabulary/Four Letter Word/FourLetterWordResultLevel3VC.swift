//
//  FourLetterWordResultLevel3VC.swift
//  Kids
//
...
class FourLetterWordResultLevel3VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "fourLetterWordLevel3Completed")
        UserDefaults.standard.set(percentage, forKey: "fourLetterWordLevel3Percentage")
