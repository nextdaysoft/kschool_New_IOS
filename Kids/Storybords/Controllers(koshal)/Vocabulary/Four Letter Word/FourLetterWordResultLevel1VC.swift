//
//  FourLetterWordResultLevel1VC.swift
//  Kids
//
...
class FourLetterWordResultLevel1VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "fourLetterWordLevel1Completed")
        UserDefaults.standard.set(percentage, forKey: "fourLetterWordLevel1Percentage")

        if let menuVC = navigationController?.viewControllers.first(
            where: { $0 is FourLetterWordMenuVC }
