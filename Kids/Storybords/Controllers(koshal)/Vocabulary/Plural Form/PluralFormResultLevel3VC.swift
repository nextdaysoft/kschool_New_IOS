//
//  PluralFormResultLevel3VC.swift
//  Kids
//
...
class PluralFormResultLevel3VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "pluralFormLevel3Completed")
        UserDefaults.standard.set(percentage, forKey: "pluralFormLevel3Percentage")
