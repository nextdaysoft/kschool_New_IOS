//
//  PluralFormResultLevel2VC.swift
//  Kids
//
...
class PluralFormResultLevel2VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "pluralFormLevel2Completed")
        UserDefaults.standard.set(percentage, forKey: "pluralFormLevel2Percentage")
