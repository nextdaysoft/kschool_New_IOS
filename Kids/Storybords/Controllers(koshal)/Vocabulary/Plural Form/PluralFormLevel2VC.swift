...
class PluralFormLevel2VC: BaseViewController {
    ...
    var questions: [PluralQuestion] = [
        ...
        PluralQuestion(
            singular: "pencil",
            correctPlural: "pencils",
            wrongPlural: "pensils"
        ),

        PluralQuestion(
            singular: "chair",
            correctPlural: "chairs",
            wrongPlural: "chaires"
        ),

        PluralQuestion(
            singular: "house",
            correctPlural: "houses",
            wrongPlural: "housses"
        ),
        ...
        PluralQuestion(
            singular: "cupcake",
            correctPlural: "cupcakes",
            wrongPlural: "cupkakes"
        ),

        PluralQuestion(
            singular: "apple",
            correctPlural: "apples",
            wrongPlural: "appleses"
        ),

        PluralQuestion(
            singular: "flower",
            correctPlural: "flowers",
            wrongPlural: "flowres"
        ),
    ...
    func goToResult() {
        ...
        let vc = storyboard.instantiateViewController(
            withIdentifier: "PluralFormResultLevel2VC"
        ) as! PluralFormResultLevel2VC
