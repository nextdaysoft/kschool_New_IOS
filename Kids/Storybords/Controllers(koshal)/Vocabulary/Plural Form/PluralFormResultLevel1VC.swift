//
//  PluralFormResultLevel1VC.swift
//  Kids
//
...
class PluralFormResultLevel1VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "pluralFormLevel1Completed")
        UserDefaults.standard.set(percentage, forKey: "pluralFormLevel1Percentage")

        if let menuVC = navigationController?.viewControllers.first(
            where: { $0 is PluralFormMenuVC }
        ) {
