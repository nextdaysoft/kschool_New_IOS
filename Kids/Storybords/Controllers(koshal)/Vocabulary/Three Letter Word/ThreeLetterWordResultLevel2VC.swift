//
//  ThreeLetterWordResultLevel2VC.swift
//  Kids
//
...
class ThreeLetterWordResultLevel2VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "threeLetterWordLevel2Completed")
        UserDefaults.standard.set(percentage, forKey: "threeLetterWordLevel2Percentage")
