...
class ThreeLetterWordLevel1VC: BaseViewController {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "ThreeLetterWordResultLevel1VC"
        ) as? ThreeLetterWordResultLevel1VC {
