//
//  ThreeLetterWordResultLevel1VC.swift
//  Kids
//
...
class ThreeLetterWordResultLevel1VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "threeLetterWordLevel1Completed")
        UserDefaults.standard.set(percentage, forKey: "threeLetterWordLevel1Percentage")
