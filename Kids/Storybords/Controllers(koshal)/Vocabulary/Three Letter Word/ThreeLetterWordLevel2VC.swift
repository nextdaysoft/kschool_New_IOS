//
//  ThreeLetterWordLevel2VC.swift
//  Kids
//
//  Created by Koshal Singh on 04/02/26.
//

//struct ThreeLetterWordResultLevel2 {
...
class ThreeLetterWordLevel2VC: BaseViewController {
    ...
    func goToResultScreen() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "ThreeLetterWordResultLevel2VC"
        ) as? ThreeLetterWordResultLevel2VC {
