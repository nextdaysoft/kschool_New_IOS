//
//  ThreeLetterWordResultLevel3VC.swift
//  Kids
//
...
class ThreeLetterWordResultLevel3VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "threeLetterWordLevel3Completed")
        UserDefaults.standard.set(percentage, forKey: "threeLetterWordLevel3Percentage")

        if let menuVC = navigationController?.viewControllers.first(
            where: { $0 is ThreeLetterWordMenuVC }
