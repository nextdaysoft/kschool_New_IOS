...
class MatchSynonymsLevel3VC: BaseViewController {
    ...
    var correctWordMap: [String: String] = [
        "Beautiful".localiz(): "Pretty".localiz(),
        "Tiny".localiz(): "Small".localiz(),
        "Angry".localiz(): "Mad".localiz(),
        "Friend".localiz(): "Buddy".localiz(),
        "Brave".localiz(): "Courageous".localiz()
    ]

    let wordPairs: [MatchSynonyms] = [
        MatchSynonyms(first: "Beautiful".localiz(), last: "Pretty".localiz()),
        MatchSynonyms(first: "Tiny".localiz(), last: "Small".localiz()),
        MatchSynonyms(first: "Angry".localiz(), last: "Mad".localiz()),
        MatchSynonyms(first: "Friend".localiz(), last: "Buddy".localiz()),
        MatchSynonyms(first: "Brave".localiz(), last: "Courageous".localiz())
    ]
    ...
    @IBAction func submitAndNextTapBtn(_ sender: UIButton) {
        ...
        if isSubmitted {
            ...
            // ✅ SAVE DATA
            UserDefaults.standard.set(true, forKey: "matchSynonymsLevel3Completed")
            UserDefaults.standard.set(percentage, forKey: "matchSynonymsLevel3Percentage")
