...
class MatchSynonymsLevel1VC: BaseViewController {
    ...
    var correctWordMap: [String: String] = [
        "Cold".localiz(): "Cool".localiz(),
        "Fast".localiz(): "Quick".localiz(),
        "Happy".localiz(): "Glad".localiz(),
        "Big".localiz(): "Large".localiz(),
        "Nice".localiz(): "Kind".localiz()
    ]

    let wordPairs: [MatchSynonyms] = [
        MatchSynonyms(first: "Cold".localiz(), last: "Cool".localiz()),
        MatchSynonyms(first: "Fast".localiz(), last: "Quick".localiz()),
        MatchSynonyms(first: "Happy".localiz(), last: "Glad".localiz()),
        MatchSynonyms(first: "Big".localiz(), last: "Large".localiz()),
        MatchSynonyms(first: "Nice".localiz(), last: "Kind".localiz())
    ]
    ...
    @IBAction func submitAndNextTapBtn(_ sender: UIButton) {
        ...
        if isSubmitted {
            ...
            // ✅ SAVE DATA
            UserDefaults.standard.set(true, forKey: "matchSynonymsLevel1Completed")
            UserDefaults.standard.set(percentage, forKey: "matchSynonymsLevel1Percentage")
