//
//  ConfusingWordsResultLevel3VC.swift
//  Kids
//
...
class ConfusingWordsResultLevel3VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "confusingWordsLevel3Completed")
        UserDefaults.standard.set(percentage, forKey: "confusingWordsLevel3Percentage")

        if let menuVC = navigationController?.viewControllers.first(
            where: { $0 is ConfusingWordsMenuVC }
