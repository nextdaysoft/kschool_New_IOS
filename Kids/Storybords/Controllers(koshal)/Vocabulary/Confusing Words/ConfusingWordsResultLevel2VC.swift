//
//  ConfusingWordsResultLevel2VC.swift
//  Kids
//
...
class ConfusingWordsResultLevel2VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "confusingWordsLevel2Completed")
        UserDefaults.standard.set(percentage, forKey: "confusingWordsLevel2Percentage")
