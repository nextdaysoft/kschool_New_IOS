//
//  ConfusingWordsResultLevel1VC.swift
//  Kids
//
...
class ConfusingWordsResultLevel1VC: BaseViewController {
    ...
    func goToMenu() {
        ...
        UserDefaults.standard.set(true, forKey: "confusingWordsLevel1Completed")
        UserDefaults.standard.set(percentage, forKey: "confusingWordsLevel1Percentage")
