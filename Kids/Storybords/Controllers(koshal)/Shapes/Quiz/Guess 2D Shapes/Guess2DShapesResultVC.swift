...
class Guess2DShapesResultVC: BaseViewController {
    ...
    func goToMenu(markCompleted: Bool = true) {
        ...
        if markCompleted {
            ...
            // ✅ Correct keys
            UserDefaults.standard.set(true, forKey: "shapesLevel2Completed")
            UserDefaults.standard.set(percentage, forKey: "shapesLevel2Percentage")
        }
