...
class Guess2DShapesShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResult() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "Guess2DShapesResultVC"
        ) as? Guess2DShapesResultVC {
