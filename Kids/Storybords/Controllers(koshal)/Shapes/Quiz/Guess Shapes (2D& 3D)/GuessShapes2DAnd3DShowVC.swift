//
//  GuessShapes2DAnd3DShowVC.swift
//  KSchool
//
...
class GuessShapes2DAnd3DShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    var planets1: [LearnPlanetsItem] = [
        ...
        LearnPlanetsItem(
            text: "Rhombus",
            imageName: "shape_rhombus"
        ),
        
        LearnPlanetsItem(
            text: "Parallelogram",
            imageName: "shape_parallelogram"
        ),
        
        LearnPlanetsItem(
            text: "Trapezium",
            imageName: "shape_trapezium"
        ),
        
        // 3D Shapes (Only Section)
        LearnPlanetsItem(
            text: "Cube",
            imageName: "shape_cube"
        ),
        
        LearnPlanetsItem(
            text: "Cuboid",
            imageName: "shape_cuboid"
        ),
        
        LearnPlanetsItem(
            text: "Sphere",
            imageName: "shape_sphere"
        ),
        
        LearnPlanetsItem(
            text: "Cone",
            imageName: "shape_cone"
        ),
        
        LearnPlanetsItem(
            text: "Cylinder",
            imageName: "shape_cylinder"
        ),
        
        LearnPlanetsItem(
            text: "Pyramid",
            imageName: "shape_pyramid"
        )
    ]
    ...
    override func viewDidLoad() {
        ...
        planets = Array(planets1.shuffled().prefix(10))
    ...
    func goToResult() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "GuessShapes2DAnd3DResultVC"
        ) as? GuessShapes2DAnd3DResultVC {
