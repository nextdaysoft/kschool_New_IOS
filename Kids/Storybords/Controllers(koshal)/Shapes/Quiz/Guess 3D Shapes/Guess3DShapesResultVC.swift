...
class Guess3DShapesResultVC: BaseViewController {
    ...
    func goToMenu(markCompleted: Bool = true) {
        ...
        if markCompleted {
            ...
            // ✅ Correct keys
            UserDefaults.standard.set(true, forKey: "shapesLevel3Completed")
            UserDefaults.standard.set(percentage, forKey: "shapesLevel3Percentage")
        }
