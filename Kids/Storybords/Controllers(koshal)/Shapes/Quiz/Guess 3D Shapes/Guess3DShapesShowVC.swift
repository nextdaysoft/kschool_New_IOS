...
class Guess3DShapesShowVC: BaseViewController, AVSpeechSynthesizerDelegate {
    ...
    func goToResult() {
        ...
        if let resultVC = storyboard.instantiateViewController(
            withIdentifier: "Guess3DShapesResultVC"
        ) as? Guess3DShapesResultVC {
